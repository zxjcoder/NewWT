...
@property (assign, nonatomic) int unReadTotalCountAll;
@property (assign, nonatomic) int unReadTotalCountPractice;
...
#define kBeenPurchasedAllDataKey [NSString stringWithFormat:@"kBeenPurchasedAllData%@", kLoginUserId]
-(void)innerDataAll
{
    if ([AppSetting getAutoLogin]) {
