...
//    [self.btnStart setBackgroundImage:[SkinManager getImageWithName:@"btn_gra3"] forState:(UIControlStateNormal)];
//    [self.btnStart setBackgroundImage:[SkinManager getImageWithName:@"btn_gra3_c"] forState:(UIControlStateHighlighted)];
