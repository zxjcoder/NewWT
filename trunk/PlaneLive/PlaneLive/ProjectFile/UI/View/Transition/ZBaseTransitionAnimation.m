//
//  ZBaseTransitionAnimation.m
//  PlaneLive
//
//  Created by WT on 26/03/2018.
//  Copyright © 2018 WT. All rights reserved.
//

#import "ZBaseTransitionAnimation.h"

@interface ZBaseTransitionAnimation()
{
...
@implementation ZBaseTransitionAnimation
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext
{
    ...
    switch (_typeStyle)
    {
        ...
        {
            toView.frame = CGRectMake(APP_FRAME_WIDTH, 0, APP_FRAME_WIDTH, APP_FRAME_HEIGHT);
        ...
        {
            [UIView animateWithDuration:_transitionTime animations:^{
                fromView.frame = CGRectMake(APP_FRAME_WIDTH, 0, APP_FRAME_WIDTH, APP_FRAME_HEIGHT);
            } completion:^(BOOL finished) {
                [containerView addSubview:toView];
                [transitionContext completeTransition:YES];
            }];
