...
-(void)innerData
{
    switch (self.type) {
        ...
        case ZSettingItemTVCTypeBugout:
        {
            ...
            [self.switchBugout setOnImage:[SkinManager getImageWithName:@"btn_gra3"]];
...
-(void)layoutSubviews
{
    ...
    switch (self.type) {
        ...
        default:
        {
            ...
            [self.lbDesc setFrame:CGRectMake(self.arrowX-105, self.cellH/2-self.lbH/2, 100, self.lbH)];
            break;
        }
    }
