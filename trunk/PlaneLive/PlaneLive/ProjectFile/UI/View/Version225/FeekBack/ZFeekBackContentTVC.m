...
-(void)innerInitItem
{
    ...
    [viewText setBackgroundColor:COLORVIEWBACKCOLOR3];
    ...
    self.lbCount = [[ZLabel alloc] initWithFrame:(CGRectMake(viewText.width-115, viewText.height-30, 100, 18))];
    [self.lbCount setTextColor:COLORTEXT3];
    [self.lbCount setText:[NSString stringWithFormat:@"%d", kFeedbackContentMaxLength]];
    [self.lbCount setFont:[ZFont systemFontOfSize:kFont_Default_Size]];
    [self.lbCount setTextAlignment:(NSTextAlignmentRight)];
    [self.lbCount setUserInteractionEnabled:false];
    ...
    [self.textView setTextColor:COLORTEXT2];
