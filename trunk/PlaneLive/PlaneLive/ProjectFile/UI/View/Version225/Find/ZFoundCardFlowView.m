...
- (UIView *)carousel:(iCarousel *)carousel viewForItemAtIndex:(NSInteger)index reusingView:(nullable UIView *)view
{
    if (view == nil) {
        ...
        [itemView setTag:index+100];
        view = itemView;
    }
    if ([view isKindOfClass:[ZFoundCardItemView class]]) {
...
{
    if ([carousel.currentItemView isKindOfClass:[ZFoundCardItemView class]]) {
        [(ZFoundCardItemView*)carousel.currentItemView btnPlayerUpOutside];
    }
}
