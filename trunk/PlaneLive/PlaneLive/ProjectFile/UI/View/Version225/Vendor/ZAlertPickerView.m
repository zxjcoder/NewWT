...
-(void)innerInitItem
{
    ...
    btnClose.frame = CGRectMake(0, self.viewContent.height-closeH, 55, closeH);
    ...
    btnDone.frame = CGRectMake(self.viewContent.width-55, self.viewContent.height-closeH, 55, closeH);
...
{
    if (IsIPhoneX) {
        return self.contentH+10+kIPhoneXButtonHeight;
    }
    return self.contentH+10;
}
/// 获取当月的天数
...
-(UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    if (view == nil) {
        ...
        [label setFont:[ZFont systemFontOfSize:kFont_Default_Size]];
