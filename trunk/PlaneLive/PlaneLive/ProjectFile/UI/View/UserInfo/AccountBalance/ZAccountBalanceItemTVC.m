...
-(void)innerInit
{
    ...
    [self.lbMoney setFont:[ZFont boldSystemFontOfSize:24]];
    ...
    [self.btnRecharge setBackgroundColor:RGBCOLORA(250, 158, 118, 0.15)];
    ...
    [self.btnRecharge setViewRound:14 borderWidth:0 borderColor:CLEARCOLOR];
    [self.btnRecharge.layer setMasksToBounds:true];
...
-(void)setViewFrame
{
    [self.lbMoney setFrame:CGRectMake(self.space, self.cellH / 2 - 13, 250, 26)];
