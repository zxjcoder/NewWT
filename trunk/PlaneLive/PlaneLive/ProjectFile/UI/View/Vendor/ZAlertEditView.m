...
-(void)getBgView
{
    ...
    [self.viewBG setBackgroundColor:COLORVIEWBACKCOLOR3];
    [self.viewBG setAlpha:kBackgroundOpacity];
...
-(void)setContentView
{
    ...
    [self.textField setTextFieldIndex:ZTextFieldIndexAlertEdit];
...
-(void)setViewFrame
{
    ...
    [self.textField setPlaceholder:kPleaseEnterTheTopic];
    [self.btnCancel setTitle:kCancel forState:(UIControlStateNormal)];
    [self.btnSave setTitle:kDetermine forState:(UIControlStateNormal)];
}
