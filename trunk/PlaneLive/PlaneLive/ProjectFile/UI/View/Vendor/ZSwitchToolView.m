...
-(void)innerInitItem
{
    ...
    switch (self.type) {
        ...
        case ZSwitchToolViewItemHomeSearch:
        {
            ...
            [self createButtonItem3];
            [self createButtonItem4];
            [self.btnItem1 setTitle:kAll forState:(UIControlStateNormal)];
            [self.btnItem2 setTitle:kPractice forState:(UIControlStateNormal)];
            [self.btnItem3 setTitle:kSeriesCourse forState:(UIControlStateNormal)];
            [self.btnItem4 setTitle:kSubscribe forState:(UIControlStateNormal)];
            break;
        }
        case ZSwitchToolViewItemHomeSearchNoSubscribe:
        {
            [self setItemCount:2];
            [self createButtonItem1];
            [self createButtonItem2];
        ...
        case ZSwitchToolViewItemDownloadManager:
        {
            ...
            [self.btnItem4 setTitle:kDownloadCourse forState:(UIControlStateNormal)];
            break;
        }
        case ZSwitchToolViewItemDownloadManagerNoSubscribe:
        {
            [self setItemCount:2];
            [self createButtonItem1];
            [self createButtonItem2];
    ...
    if (!self.imageLine) {
        ...
        self.imageLine.frame = CGRectMake(20, self.height-kLineHeight, self.width-40, kLineHeight);
...
-(void)createButtonItem1
{
    if (!self.btnItem1) {
        ...
        [self.btnItem1 setTitleColor:COLORTEXT1 forState:(UIControlStateNormal)];
        [self.btnItem1 setTitleColor:COLORTEXT1 forState:(UIControlStateHighlighted)];
...
-(void)createButtonItem2
{
    if (!self.btnItem2) {
        ...
        [self.btnItem2 setTitleColor:COLORTEXT3 forState:(UIControlStateNormal)];
        [self.btnItem2 setTitleColor:COLORTEXT3 forState:(UIControlStateHighlighted)];
...
-(void)createButtonItem3
{
    if (!self.btnItem3) {
        ...
        [self.btnItem3 setTitleColor:COLORTEXT3 forState:(UIControlStateNormal)];
        [self.btnItem3 setTitleColor:COLORTEXT3 forState:(UIControlStateHighlighted)];
...
-(void)createButtonItem4
{
    if (!self.btnItem4) {
        ...
        [self.btnItem4 setTitleColor:COLORTEXT3 forState:(UIControlStateNormal)];
        [self.btnItem4 setTitleColor:COLORTEXT3 forState:(UIControlStateHighlighted)];
        [self.btnItem4 setTag:4];
        [[self.btnItem4 titleLabel] setFont:[ZFont systemFontOfSize:kFont_Default_Size]];
...
-(void)layoutSubviews
{
    ...
    if (self.viewLine.frame.origin.x==0) {
        CGFloat space = self.itemW/2-30/2;
        [self.viewLine setFrame:CGRectMake(space, lineY, 30, lineH)];
    }
    self.imageLine.frame = CGRectMake(20, self.height-kLineHeight, self.width-40, kLineHeight);
...
-(void)itemChange:(NSInteger)index
{
    switch (index) {
        ...
        {
            if (self.btnItem1) {
                [self.btnItem1 setTitleColor:COLORTEXT3 forState:(UIControlStateNormal)];
            }
            if (self.btnItem2) {
                [self.btnItem2 setTitleColor:COLORTEXT1 forState:(UIControlStateNormal)];
            }
            if (self.btnItem3) {
                [self.btnItem3 setTitleColor:COLORTEXT3 forState:(UIControlStateNormal)];
            }
        ...
        case 3:
        {
            ...
            if (self.btnItem3) {
                [self.btnItem3 setTitleColor:COLORTEXT1 forState:(UIControlStateNormal)];
            }
            if (self.btnItem4) {
                [self.btnItem4 setTitleColor:COLORTEXT3 forState:(UIControlStateNormal)];
            }
        ...
        case 4:
        {
            ...
            if (self.btnItem4) {
                [self.btnItem4 setTitleColor:COLORTEXT1 forState:(UIControlStateNormal)];
            }
            break;
        }
        default:break;
