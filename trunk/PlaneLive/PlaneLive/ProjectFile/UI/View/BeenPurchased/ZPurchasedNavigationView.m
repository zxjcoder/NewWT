...
///全部小红点
@property (strong, nonatomic) UIView *viewPoint0;
///微课小红点
...
-(void)innerInit
{
    ...
    self.viewPoint0 = [self createItemView];
    [self.btnItem0 addSubview:self.viewPoint0];
    
    self.viewPoint1 = [self createItemView];
    [self.btnItem1 addSubview:self.viewPoint1];
...
{
    [self.viewPoint0 setHidden:unReadTotalCount<=0];
}
-(void)setPracticePoint:(int)unReadTotalCount
{
    [self.viewPoint1 setHidden:unReadTotalCount<=0];
}
