...
#define kNOTIFIER_LABEL_FONT [UIFont systemFontOfSize:14] //([UIFont fontWithName:@"HelveticaNeue-Light" size:17])
#define kNOTIFIER_CANCEL_FONT [UIFont systemFontOfSize:13] //([UIFont fontWithName:@"HelveticaNeue" size:13])

@implementation UIView (MJAlertView)

static const NSInteger kTagMJAlertView = 1812;
static const NSInteger xPadding = 20.0;
...
{
    [self addMJNotifierWithText:text dismissAutomatically:shouldDismiss backgroundColor:RGBCOLORA(249,65,55,0.7) textColor:WHITECOLOR];
}
+ (void)addMJNotifierSuccessWithText:(NSString *)text dismissAutomatically:(BOOL)shouldDismiss
{
    [self addMJNotifierWithText:text dismissAutomatically:shouldDismiss backgroundColor:RGBCOLORA(0,0,0,0.7) textColor:WHITECOLOR];
}
