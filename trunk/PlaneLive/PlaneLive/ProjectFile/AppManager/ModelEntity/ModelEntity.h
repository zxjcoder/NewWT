...
///通知消息列表课程对象
@interface ModelNoticeCourse: ModelEntity

///ID
@property (strong ,nonatomic) NSString *ids;
///微课,系列课,培训课,系列课子课程,培训课子课程 - 标题
@property (strong ,nonatomic) NSString *title;
///系列课,培训课 - 标题
...
///数据类型: 0微课,1系列课,2培训课,3系列课子课程,4培训课子课程
@property (assign ,nonatomic) ZNoticeCourseType type;
///购买状态: 0未购买,1已购买
...
@property (strong ,nonatomic) NSString *content;
///消息类型: 1系统消息,2课程更新
@property (assign ,nonatomic) ZNoticeType type;
///查看状态: 0已查看,1未查看
@property (assign ,nonatomic) int readstatus;
///消息发布时间
@property (strong ,nonatomic) NSString *createtime;

///课程对象
@property (strong ,nonatomic) ModelNoticeCourse *modelCourse;
...
///微信昵称
@property (strong ,nonatomic) NSString *wechat_name;
...
///播放时长
@property (retain ,nonatomic) NSString *play_time;
///主讲人
@property (retain ,nonatomic) NSString *speaker;
///主讲人机构名称
@property (retain ,nonatomic) NSString *teanname;
///收藏者ID，
...
/// 是否有预告（0-否，1-是）
@property (assign ,nonatomic) int is_notice;
/// 预告 
@property (retain ,nonatomic) NSString *notice;
/// 邮件内容
@property (retain ,nonatomic) NSString *attachment_desc;
///收藏数
...
@property (nonatomic, assign) int audio_sizeBT;
@property (nonatomic, assign) CGFloat audio_sizeMB;
///0不是系列课程 1是系列课程
@property (assign ,nonatomic) int is_series_course;
///收听数
@property (assign ,nonatomic) long hits;
