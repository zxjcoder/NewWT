...
@implementation ModelNoticeCourse
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self) {
        if ([dic isKindOfClass:[NSDictionary class]]) {
            ...
            self.title = [Utils getSNSString:dic[@"title"]];
            self.stitle = [Utils getSNSString:dic[@"stitle"]];
            self.icon = [Utils getSNSString:dic[@"icon"]];
            self.speaker = [Utils getSNSString:dic[@"speaker"]];
            self.type = [Utils getSNSInt:dic[@"type"]];
            self.audioPath = [Utils getSNSString:dic[@"audioPath"]];
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self) {
        if ([dic isKindOfClass:[NSDictionary class]]) {
            ...
            self.content = [Utils getSNSString:dic[@"content"]];
            self.type = [Utils getSNSInt:dic[@"type"]];
            self.readstatus = [Utils getSNSInt:dic[@"readStatus"]];
            self.createtime = [Utils getSNSString:dic[@"createTime"]];
            
            NSDictionary *dicCourse = [dic objectForKey:@"course"];
            if (dicCourse && [dicCourse isKindOfClass:[NSDictionary class]]) {
                self.modelCourse = [[ModelNoticeCourse alloc] initWithCustom:dicCourse];
            }
        }
    }
    return self;
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self) {
        ...
        self.loginToken = [Utils getSNSString:dic[@"loginToken"]];
        self.loginTime = [Utils getSNSString:dic[@"login_time"]];
        
        self.unReadTotalCount = [Utils getSNSInt:dic[@"unReadTotalCount"]];
        self.shoppingCartCount = [Utils getSNSInt:dic[@"shoppingCartCount"]];
        
        self.loginType = [Utils getSNSInt:dic[@"login_type"]];
        self.isShowAlert = [Utils getSNSBool:dic[@"isShowAlert"]];
        self.alertTitle = [Utils getSNSString:dic[@"alertTitle"]];
        self.alertContent = [Utils getSNSString:dic[@"alertContent"]];
        self.flag = [Utils getSNSInt:dic[@"flag"]];
        
        self.feekbackPhone = [Utils getSNSString:dic[@"feekbackPhone"]];
        ...
        self.wechat_name = [Utils getSNSString:dic[@"wechat_name"]];
        ...
        self.myMessageCount = [Utils getSNSInt:dic[@"myMessageCount"]];
        self.myCommentCount = [Utils getSNSInt:dic[@"myCommentCount"]];
        
        self.myCommentReplyCount = [Utils getSNSInt:dic[@"ansCount"]];
        self.myReplyCount = [Utils getSNSInt:dic[@"myReplyCount"]];
        
        self.myFeedbackReplyCount = [Utils getSNSInt:dic[@"myUnReadReplyCount"]];
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self&&dic) {
        ...
        self.title = [Utils getSNSString:dic[@"title"]];
        self.share_title = [Utils getSNSString:dic[@"share_title"]];
        self.share_desc = [Utils getSNSString:dic[@"share_desc"]];
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self&&dic) {
        ...
        self.type = [Utils getSNSString:dic[@"type"]];
        self.play_time = [Utils getSNSString:dic[@"playtime"]];
        self.speaker = [Utils getSNSString:dic[@"speaker"]];
        self.teanname = [Utils getSNSString:dic[@"team"]];
        self.subscribe_id = [Utils getSNSString:dic[@"sid"]];
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self&&dic) {
        ...
        self.is_notice = [Utils getSNSInt:dic[@"is_notice"]];
        self.notice = [Utils getSNSString:dic[@"notice"]];
        self.attachment_desc = [Utils getSNSString:dic[@"attachment_desc"]];
        
        id speechImges = [dic objectForKey:@"speech_images"];
        if (speechImges && [speechImges isKindOfClass:[NSArray class]]) {
            NSMutableArray *arrCourseImges = [NSMutableArray array];
            for (id speechImge in speechImges) {
                if ([speechImge isKindOfClass:[NSDictionary class]]) {
                    [arrCourseImges addObject:[speechImge objectForKey:@"url"]];
                } else if ([speechImge isKindOfClass:[NSString class]]) {
                    [arrCourseImges addObject:speechImge];
                }
            }
            self.arrImage = [NSArray arrayWithArray:arrCourseImges];
        } else if (speechImges && [speechImges isKindOfClass:[NSString class]]) {
            NSArray *arrCourseImges = [speechImges componentsSeparatedByString:@"@"];
        ...
        self.hits = [Utils getSNSLong:dic[@"hits"]];
        ...
        self.increasedCourseCount = [Utils getSNSInt:dic[@"increasedCourseCount"]];
    }
    return self;
}
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self&&dic) {
        ...
        self.price = [Utils getSNSString:dic[@"price"]];
        self.units = [Utils getSNSString:dic[@"units"]];
        self.time = [Utils getSNSString:dic[@"create_time"]];
        ...
        self.is_series_course = [Utils getSNSInt:dic[@"is_series_course"]];
        self.isExistFreeRead = [Utils getSNSBool:dic[@"isExistFreeRead"]];
        self.freeReadCount = [Utils getSNSInt:dic[@"freeReadCount"]];
        self.increasedCourseCount = [Utils getSNSInt:dic[@"increasedCourseCount"]];
    }
    return self;
}
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self&&dic) {
        ...
        self.pay_type = [Utils getSNSString:dic[@"pay_type"]];
        self.type = [Utils getSNSInt:dic[@"type"]];
    }
    return self;
}
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self&&dic) {
        ...
        self.createTimeFormat = [Utils getSNSString:dic[@"createTimeFormat"]];
        self.create_time = [Utils getSNSString:dic[@"create_time"]];
        self.illustration = [Utils getSNSString:dic[@"illustration"]];
        self.course_picture = [Utils getSNSString:dic[@"course_picture"]];
        self.attachment_desc = [Utils getSNSString:dic[@"attachment_desc"]];
        ...
        if (courseImges && [courseImges isKindOfClass:[NSArray class]]) {
            NSMutableArray *arrayImges = [NSMutableArray array];
            for (id courseImage in courseImges) {
                if ([courseImage isKindOfClass:[NSDictionary class]]) {
                    [arrayImges addObject:[courseImage objectForKey:@"url"]];
                } else if ([courseImage isKindOfClass:[NSString class]]) {
                    [arrayImges addObject:courseImage];
                }
            }
            self.course_imges = [NSArray arrayWithArray:arrayImges];
        ...
        self.audio_sizeBT = [Utils getSNSInt:dic[@"size"]];
        if (self.audio_sizeBT > 0) {
            self.audio_sizeMB = self.audio_sizeBT/1024/1024;
        }
        self.hits = [Utils getSNSLong:dic[@"hits"]];
        self.free_read = [Utils getSNSInt:dic[@"free_read"]];
        self.unReadCount = [Utils getSNSInt:dic[@"unReadCount"]];
        ...
        self.mcount = [Utils getSNSLong:dic[@"messageCount"]];
        self.applauds = [Utils getSNSLong:dic[@"applaudCount"]];
        self.ccount = [Utils getSNSLong:dic[@"collectCount"]];
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self&&dic) {
        self.ids = [Utils getSNSString:dic[@"id"]];
        self.type = [Utils getSNSString:dic[@"type"]];
        self.spe_img = [Utils getSNSString:dic[@"spe_img"]];
...
@implementation ModelRewardRecord
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self&&dic) {
        ...
        self.course_id = [Utils getSNSString:dic[@"course_id"]];
        self.subscribe_id = [Utils getSNSString:dic[@"cid"]];
        self.create_time = [Utils getSNSString:dic[@"create_time"]];
        self.title = [Utils getSNSString:dic[@"title"]];
        self.price = [Utils getSNSString:dic[@"price"]];
        self.units = [Utils getSNSString:dic[@"units"]];
        
        self.applaudCount = [Utils getSNSLong:dic[@"applaudCount"]];
        self.free_read = [Utils getSNSInt:dic[@"free_read"]];
        
        self.reply = [Utils getSNSString:dic[@"reply"]];
        self.reply_lecturer = [Utils getSNSString:dic[@"reply_lecturer"]];
        self.reply_time = [Utils getSNSString:dic[@"reply_time"]];
    }
    return self;
}
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self&&dic) {
        self.ids = [Utils getSNSString:dic[@"id"]];
        self.title = [Utils getSNSString:dic[@"lawfirm_name"]];
        self.desc = [Utils getSNSString:dic[@"lawfirm_intro"]];
        self.logo = [Utils getSNSString:dic[@"logo"]];
        self.picture = [Utils getSNSString:dic[@"bg_img"]];
        self.total = [Utils getSNSInt:dic[@"total"]];
    }
    return self;
}
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self&&dic) {
        ...
        self.reply = [Utils getSNSString:dic[@"reply"]];
        self.createTime = [Utils getSNSString:dic[@"create_time"]];
        self.replyTime = [Utils getSNSString:dic[@"reply_time"]];
        NSString *image = [Utils getSNSString:dic[@"img_url"]];
        if (image && [image isKindOfClass:[NSString class]] && image.length > 0) {
            self.images = [image componentsSeparatedByString:@","];
        }
    }
    return self;
}
