...
#define kSNS_RETURN_NOTBALANCE 1009
#define kSNS_RETURN_NOTBALANCE_Text NSLocalizedString(@"余额不足", nil)

#define kSNS_RETURN_SERVER_DEFAULT_Text NSLocalizedString(@"网络连接错误[10000]", nil)

#define kSNS_RETURN_SERVER_DATA_ERROR 10001
#define kSNS_RETURN_SERVER_DATA_ERROR_Text  NSLocalizedString(@"请求数据错误[10001]", nil)

#define kSNS_RETURN_SERVER_DECRYPTDATA_ERROR 10002
#define kSNS_RETURN_SERVER_DECRYPTDATA_ERROR_Text  NSLocalizedString(@"请求处理错误[10002]", nil)

#define kSNS_RETURN_SERVER_TOKEN_EXPIRED 2000
#define kSNS_RETURN_SERVER_TOKEN_EXPIRED_Text  NSLocalizedString(@"登录已过期[2000]", nil)
