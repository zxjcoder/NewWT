...
///App审核状态改变
static NSString *const ZAppAuditStatusChangeNotification = @"ZAppAuditStatusChangeNotification";
...
///微课购买成功
static NSString *const ZPracticePaySuccessNotification = @"ZPracticePaySuccessNotification";

///scrollview滑动通知
static NSString *const ZScrollViewDelegateNotification = @"ZScrollViewDelegateNotification";

///播放改变目录
static NSString *const ZPlayerChangeListNotification = @"ZPlayerChangeListNotification";
