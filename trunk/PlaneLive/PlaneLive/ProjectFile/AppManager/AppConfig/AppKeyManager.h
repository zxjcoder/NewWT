...
//检查是否有网络
#define kCHECK_HUHUSERVER_URL @"https://www.apple.com"
//客服微信
#define kWeChatCustomerServiceNumber @"wutong_Live"
//客服电话
#define kCustomerServiceTelephoneNumberValue @"028-83256569"
...
//项目APP地址
#define kApp_AppUrl [NSString stringWithFormat:@"itms-apps://itunes.apple.com/cn/app/id%@", kApp_AppId]
//App检测版本地址
#define kApp_CheckVersionUrl [NSString stringWithFormat:@"https://itunes.apple.com/cn/lookup?id=%@", kApp_AppId]

//使用协议地址
#define kApp_ProtocolUrl @"agreement.html"
//微信客服
#define kApp_WeChatServiceUrl @"weixin"
//充值指南地址
#define kApp_RechargeGuideUrl @"help/rechargeguide.html"
//摇一摇意见反馈地址
#define kApp_BugShakeUrl @"help/what_is_bugShake.html"

//诸葛IO
#define kZhugeIO_AppKey @"9b8db7d1a0cb417694bf7ac5997f67b4"

//高德地图
#define kAMapAppKey @"c796f0a7c7f977c1b58dc0db3bd57750"
...
#define kUMeng_Type @"kUMessageAliasTypePlaneLive"

//Testin_Bugout平台
#define kBugout_AppKey @"c82897e46dfbdb94ecdb1d5b2d564dce"

//腾讯BUG平台
#define kTencentBugly_AppId @"da01efab45"
#define kTencentBugly_GroupId @"wutonglivebuggroupid"
...
//微信回调 - 支付用pay 登录授权需要 oauth
#define kWechat_Auth_URLHost_Key @"oauth"
//统一下单的接口链接
