...
-(void)setSearchContentRefreshHeader
{
    ...
    [snsV1 getCircleQueryQuestionAnswerWithUserId:[AppSetting getUserDetauleId] content:self.lastSearchContent pageNum:weakSelf.pageSearchContnet resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
-(void)setSearchUserRefreshHeader
{
    ...
    [snsV1 getCircleSearchUserWithUserId:[AppSetting getUserDetauleId] content:self.lastSearchContent pageNum:weakSelf.pageSearchUser resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
            NSMutableDictionary *dicResult = [NSMutableDictionary dictionaryWithDictionary:result];
            [dicResult setObject:@"YES" forKey:kIsHeaderKey];
...
{
    ZWEAKSELF
    [snsV1 getCircleQueryQuestionAnswerWithUserId:[AppSetting getUserDetauleId] content:self.lastSearchContent pageNum:weakSelf.pageSearchContnet+1 resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
{
    ZWEAKSELF
    [snsV1 getCircleSearchUserWithUserId:[AppSetting getUserDetauleId] content:self.lastSearchContent pageNum:weakSelf.pageSearchUser+1 resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
