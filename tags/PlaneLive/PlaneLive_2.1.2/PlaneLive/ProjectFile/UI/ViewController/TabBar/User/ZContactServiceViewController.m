...
-(void)innerInit
{
    ...
    [self.lbUserDesc setText:@"您在使用APP时有任何疑问，请通过官方客服联系我们。我们会尽快给您处理～"];
    ...
    [self.btnWeChat setTitle:@"立即关注" forState:(UIControlStateNormal)];
    ...
    [self.lbPhone setText:[NSString stringWithFormat:@"客服电话: %@", kCustomerServiceTelephoneNumbers]];
    ...
    [self.btnPhone setTitle:@"立即拨打" forState:(UIControlStateNormal)];
