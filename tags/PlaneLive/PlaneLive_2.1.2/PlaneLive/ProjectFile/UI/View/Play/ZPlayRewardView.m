...
-(void)innerInitWithTitle:(NSString *)title organization:(NSString *)organization
{
    ...
    [self.lbDesc setText:@"您的赞赏是讲师最大的动力"];
    ...
    [self.btnReward setTitle:@"打赏" forState:(UIControlStateNormal)];
    ...
    for (int i = 0; i < 6; i++) {
        ...
        switch (i) {
            case 1:
            {
                ...
                [btnItem setTitle:@"5元" forState:(UIControlStateNormal)];
                break;
            }
            case 2:
            {
                ...
                [btnItem setBackgroundColor:RGBCOLOR(243, 243, 243)];
                [btnItem setTitleColor:BLACKCOLOR forState:(UIControlStateNormal)];
                [btnItem setTitle:@"66元" forState:(UIControlStateNormal)];
                break;
            }
            case 3:
            {
                ...
                [btnItem setBackgroundColor:RGBCOLOR(243, 243, 243)];
                [btnItem setTitleColor:BLACKCOLOR forState:(UIControlStateNormal)];
                [btnItem setTitle:@"88元" forState:(UIControlStateNormal)];
                break;
            }
            case 4:
            {
                ...
                [btnItem setBackgroundColor:RGBCOLOR(243, 243, 243)];
                [btnItem setTitleColor:BLACKCOLOR forState:(UIControlStateNormal)];
                [btnItem setTitle:@"166元" forState:(UIControlStateNormal)];
                break;
            }
            case 5:
            {
                ...
                [btnItem setBackgroundColor:RGBCOLOR(243, 243, 243)];
                [btnItem setTitleColor:BLACKCOLOR forState:(UIControlStateNormal)];
                [btnItem setTitle:@"188元" forState:(UIControlStateNormal)];
                break;
            }
            default:
                ...
                [btnItem setTitle:@"2元" forState:(UIControlStateNormal)];
