...
-(void)innerInit
{
    ...
    self.viewHeader = [[ZHomeItemNavView alloc] initWithFrame:CGRectMake(0, 0, self.cellW, kZHomeItemNavViewHeight) title:@"热门订阅" desc:@"什么是订阅?" alignment:NSTextAlignmentLeft];
