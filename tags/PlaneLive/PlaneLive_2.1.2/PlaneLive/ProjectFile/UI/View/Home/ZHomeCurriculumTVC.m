...
-(void)innerInit
{
    ...
    self.viewHeader = [[ZHomeItemNavView alloc] initWithFrame:CGRectMake(0, 0, self.cellW, kZHomeItemNavViewHeight) title:@"精彩系列课" desc:@"什么是系列课?" alignment:NSTextAlignmentLeft];
