...
-(CGFloat)setCellDataWithModel:(ModelMyMessage *)model
{
    ...
    [self.lbTime setText:[NSString stringWithFormat:@"编写于%@    %ld人点赞", model.create_time, model.applaudCount]];
    [self.lbContent setText:model.content];
    [self.lbReply setText:[NSString stringWithFormat:@"讲师回复: %@", model.reply]];
    [self.lbReply setTextColor:BLACKCOLOR1];
