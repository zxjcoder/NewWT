 ...
 *  @param errorBlock   错误回调
 */
-(void)getPracticeTypePracticeArrayWithParam:(NSString *)param pageNum:(int)pageNum resultBlock:(void(^)(NSArray *arrResult, NSDictionary *result))resultBlock errorBlock:(void(^)(NSString *msg))errorBlock;
