...
- (id)initWithPrePhotoBrowser:(ZPictureViewerViewController *)browser {
    if ((self = [super init])) {
        // Delegate
        ...
        _progressView.trackTintColor    = browser.trackTintColor    ? [(ZPictureViewerViewController*)self.photoBrowser trackTintColor]    : [UIColor colorWithWhite:0.2 alpha:1];
        _progressView.progressTintColor = browser.progressTintColor ? [(ZPictureViewerViewController*)self.photoBrowser progressTintColor] : [UIColor colorWithWhite:1.0 alpha:1];
