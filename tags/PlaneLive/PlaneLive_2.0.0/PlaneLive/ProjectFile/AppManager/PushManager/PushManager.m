...
+(void)setPushContentWithUserInfo:(NSDictionary*)userInfo
{
    if (userInfo && [userInfo isKindOfClass:[NSDictionary class]]) {
        ...
        if (custom && ![custom isKindOfClass:[NSNull class]] && [custom isKindOfClass:[NSString class]]) {
            NSDictionary *dicCustom = [NSJSONSerialization JSONObjectWithData:[custom dataUsingEncoding:NSUTF8StringEncoding] options:NSJSONReadingMutableContainers error:nil];
