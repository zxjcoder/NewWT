...
#define kZSubscribeEachWatchTVCeight (70+kZSubscribeEachWatchBannerViewHeight)
...
-(void)innerInit
{
    ...
    self.imgBanner = [[ZImageView alloc] initWithFrame:CGRectMake(kSizeSpace, self.lbDesc.y+self.lbDesc.height+kSize8, self.cellW-kSizeSpace*2, kZSubscribeEachWatchBannerViewHeight)];
    [self.imgBanner setImage:[SkinManager getMaxImage]];
    [self.viewMain addSubview:self.imgBanner];
    
    self.lbTime = [[ZLabel alloc] initWithFrame:CGRectMake(kSizeSpace, self.imgBanner.y+self.imgBanner.height+kSize5, 100, self.lbMinH)];
    ...
    self.lbReadText = [[ZLabel alloc] initWithFrame:CGRectMake(self.cellW-kSizeSpace-80, self.imgBanner.y+self.imgBanner.height+kSize5, 80, self.lbMinH)];
