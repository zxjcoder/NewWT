...
-(void)btnRightClick
{
    ...
    [DataOper postCircleUpdateQuestionWithUserId:[AppSetting getUserDetauleId] questionId:self.modelQD.ids question:newTitle quizDetail:newContent articles:strTpoicArr resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
