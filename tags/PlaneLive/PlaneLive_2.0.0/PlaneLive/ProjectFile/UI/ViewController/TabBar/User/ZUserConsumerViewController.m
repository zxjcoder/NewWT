...
-(void)setRefreshPayHeader
{
    ZWEAKSELF
    self.pageNumPay = 1;
    [DataOper200 getMySubscribePlayArrayWithPageNum:self.pageNumPay resultBlock:^(NSArray *arrResult, NSDictionary *result) {
...
{
    ZWEAKSELF
    [DataOper200 getMySubscribePlayArrayWithPageNum:self.pageNumPay+1 resultBlock:^(NSArray *arrResult, NSDictionary *result) {
...
-(void)setRefreshRechargeHeader
{
    ...
    [DataOper200 getMyRechargeRecordArrayWithPageNum:self.pageNumRecharge resultBlock:^(NSArray *arrResult, NSDictionary *result) {
...
{
    ZWEAKSELF
    [DataOper200 getMyRechargeRecordArrayWithPageNum:self.pageNumRecharge+1 resultBlock:^(NSArray *arrResult, NSDictionary *result) {
