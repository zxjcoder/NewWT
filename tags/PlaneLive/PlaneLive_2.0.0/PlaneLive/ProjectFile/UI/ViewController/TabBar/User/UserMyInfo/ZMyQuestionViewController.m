...
{
    [DataOper postDeleteQuestionWithUserId:[AppSetting getUserDetauleId] questionId:model.ids resultBlock:nil errorBlock:nil];
}

-(void)setDeleteNewClick:(ModelMyNewQuestion *)model
{
    [DataOper postDeleteQuestionWithQuestionId:model.ids resultBlock:nil errorBlock:nil];
}
...
-(void)setRefreshAllData:(BOOL)isRefresh
{
    ...
    [DataOper postMyGetQueryQuestionWithUserId:self.modelUB.userId pageNum:self.pageNumAll resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
{
    ZWEAKSELF
    [DataOper postMyGetQueryQuestionWithUserId:self.modelUB.userId pageNum:self.pageNumAll+1 resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
-(void)setRefreshNewData:(BOOL)isRefresh
{
    ...
    [DataOper postMyGetUpdQuestionWithUserId:self.modelUB.userId pageNum:self.pageNumNew resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
{
    ZWEAKSELF
    [DataOper postMyGetUpdQuestionWithUserId:self.modelUB.userId pageNum:self.pageNumNew+1 resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
