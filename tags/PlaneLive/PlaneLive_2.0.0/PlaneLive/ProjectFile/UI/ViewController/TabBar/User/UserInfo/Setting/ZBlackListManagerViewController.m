...
-(void)setRefreshData:(BOOL)isSetState
{
    ...
    [DataOper postGetBlackListWithUserId:[AppSetting getUserDetauleId] pageNum:self.pageNum resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
-(void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:( NSIndexPath *)indexPath
{
    switch (editingStyle) {
        case UITableViewCellEditingStyleDelete:
        {
            ...
            [DataOper postRemoveBlackListWithUserId:[AppSetting getUserDetauleId] removeUserId:model.userId resultBlock:nil errorBlock:nil];
