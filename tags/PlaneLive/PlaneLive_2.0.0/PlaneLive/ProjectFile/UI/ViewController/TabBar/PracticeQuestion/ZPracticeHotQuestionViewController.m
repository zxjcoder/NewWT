...
-(void)setRefreshHeader
{
    self.pageNum = 1;
    ZWEAKSELF
    [DataOper130 getPracticeQuestionArrayWithPracticeId:self.modelP.ids type:(ZPracticeQuestionTypeHot) pageNum:self.pageNum pageSize:kPAGE_MAXCOUNT resultBlock:^(NSArray *arrResult, int pageSizeHot, NSInteger questionCount) {
        GCDMainBlock(^{
...
{
    ZWEAKSELF
    [DataOper130 getPracticeQuestionArrayWithPracticeId:self.modelP.ids type:(ZPracticeQuestionTypeHot) pageNum:self.pageNum+1 pageSize:kPAGE_MAXCOUNT resultBlock:^(NSArray *arrResult, int pageSizeHot, NSInteger questionCount) {
        GCDMainBlock(^{
            weakSelf.pageNum += 1;
