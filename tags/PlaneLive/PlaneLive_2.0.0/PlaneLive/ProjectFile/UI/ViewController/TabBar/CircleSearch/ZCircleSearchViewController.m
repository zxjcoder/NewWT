...
-(void)setSearchContentRefreshHeader
{
    ...
    [DataOper getCircleQueryQuestionAnswerWithUserId:[AppSetting getUserDetauleId] content:self.lastSearchContent pageNum:weakSelf.pageSearchContnet resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
-(void)setSearchUserRefreshHeader
{
    ...
    [DataOper getCircleSearchUserWithUserId:[AppSetting getUserDetauleId] content:self.lastSearchContent pageNum:weakSelf.pageSearchUser resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
            NSMutableDictionary *dicResult = [NSMutableDictionary dictionaryWithDictionary:result];
            [dicResult setObject:@"YES" forKey:kIsHeaderKey];
...
{
    ZWEAKSELF
    [DataOper getCircleQueryQuestionAnswerWithUserId:[AppSetting getUserDetauleId] content:self.lastSearchContent pageNum:weakSelf.pageSearchContnet+1 resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
{
    ZWEAKSELF
    [DataOper getCircleSearchUserWithUserId:[AppSetting getUserDetauleId] content:self.lastSearchContent pageNum:weakSelf.pageSearchUser+1 resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
{
    //添加统计事件
    [StatisticsManager event:kEvent_Circle_Search category:kCategory_Circle];
