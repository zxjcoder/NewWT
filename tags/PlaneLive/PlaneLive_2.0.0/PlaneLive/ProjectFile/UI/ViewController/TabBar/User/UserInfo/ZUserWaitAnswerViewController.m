...
-(void)setRefreshData:(BOOL)isRefresh
{
    ...
    [DataOper postMyGetQueryInviteAnswersWithUserId:self.modelUB.userId pageNum:self.pageNum resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
{
    ZWEAKSELF
    [DataOper postMyGetQueryInviteAnswersWithUserId:self.modelUB.userId pageNum:self.pageNum+1 resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
            weakSelf.pageNum += 1;
...
-(void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:( NSIndexPath *)indexPath
{
    switch (editingStyle) {
        case UITableViewCellEditingStyleDelete:
        {
            ...
            [DataOper postMyDelInviteAnswersWithUserId:[AppSetting getUserDetauleId] questionId:model.ids resultBlock:nil errorBlock:nil];
