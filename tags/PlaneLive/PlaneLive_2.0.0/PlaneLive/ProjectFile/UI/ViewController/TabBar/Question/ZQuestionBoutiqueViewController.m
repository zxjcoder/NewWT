...
-(void)setRefreshHeader
{
    ZWEAKSELF
    self.pageNum = 1;
    [DataOper200 getBoutiqueQuestionAndAnswerWithPageNum:self.pageNum resultBlock:^(NSArray *arrResult, NSDictionary *result) {
...
{
    ZWEAKSELF
    [DataOper200 getBoutiqueQuestionAndAnswerWithPageNum:self.pageNum+1 resultBlock:^(NSArray *arrResult, NSDictionary *result) {
