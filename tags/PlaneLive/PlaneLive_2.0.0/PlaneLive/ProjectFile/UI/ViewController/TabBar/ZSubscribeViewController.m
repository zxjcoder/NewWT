...
-(void)innerInit
{
    ...
    [self.tvItem1 setOnSubscribeClick:^(ModelCurriculum *model) {
    ...
    [self.tvItem1 setOnCurriculumClick:^(ModelCurriculum *model) {
...
-(void)setRefreshRecommendHeader
{
    ...
    [DataOper200 getSubscribeRecommendArrayWithPageNum:self.pageNumRecommend resultBlock:^(NSArray *arrResult, NSDictionary *result) {
...
{
    ZWEAKSELF
    [DataOper200 getSubscribeRecommendArrayWithPageNum:self.pageNumRecommend+1 resultBlock:^(NSArray *arrResult, NSDictionary *result) {
...
-(void)setRefreshAlreadyHeader
{
    if ([AppSetting getAutoLogin]) {
        ...
        [DataOper200 getSubscribeAlreadyWithPageNum:self.pageNumAlready resultBlock:^(NSArray *arrResult, NSDictionary *result) {
...
{
    ZWEAKSELF
    [DataOper200 getSubscribeAlreadyWithPageNum:self.pageNumAlready+1 resultBlock:^(NSArray *arrResult, NSDictionary *result) {
