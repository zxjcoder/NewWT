...
-(void)setRefreshHeader
{
    ZWEAKSELF
    self.pageNum = 1;
    [DataOper200 getPracticeTypeArrayWithPageNum:self.pageNum resultBlock:^(NSArray *arrResult, NSDictionary *result) {
...
{
    ZWEAKSELF
    [DataOper200 getPracticeTypeArrayWithPageNum:self.pageNum+1 resultBlock:^(NSArray *arrResult, NSDictionary *result) {
