...
- (void)viewDidLoad
{
    ...
    [self setTitle:kPracticalQuestionsAndAnswers];
...
{
    ZWEAKSELF
    [DataOper130 getPracticeQuestionArrayWithPracticeId:self.modelP.ids type:(ZPracticeQuestionTypeHot) pageNum:1 pageSize:0 resultBlock:^(NSArray *arrResult, int pageSizeHot, NSInteger questionCount) {
        GCDMainBlock(^{
...
-(void)setRefreshNewHeader
{
    self.pageNum = 1;
    ZWEAKSELF
    [DataOper130 getPracticeQuestionArrayWithPracticeId:self.modelP.ids type:(ZPracticeQuestionTypeNew) pageNum:1 pageSize:kPAGE_MAXCOUNT resultBlock:^(NSArray *arrResult, int pageSizeHot, NSInteger questionCount) {
        GCDMainBlock(^{
...
{
    ZWEAKSELF
    [DataOper130 getPracticeQuestionArrayWithPracticeId:self.modelP.ids type:(ZPracticeQuestionTypeNew) pageNum:self.pageNum+1 pageSize:kPAGE_MAXCOUNT resultBlock:^(NSArray *arrResult, int pageSizeHot, NSInteger questionCount) {
        GCDMainBlock(^{
            weakSelf.pageNum += 1;
