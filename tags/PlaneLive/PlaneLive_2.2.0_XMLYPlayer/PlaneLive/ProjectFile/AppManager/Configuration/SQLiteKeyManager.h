...
//是否第一次启动
#define kSQLITE_FRIST_START @"ZSQLITE_FRIST_START220"
//文件大小
...
#define kSQLITEPlayViewLastPlayIndex [NSString stringWithFormat:@"kSQLITEPlayViewLastPlayIndex%@", [AppSetting getUserDetauleId]]
