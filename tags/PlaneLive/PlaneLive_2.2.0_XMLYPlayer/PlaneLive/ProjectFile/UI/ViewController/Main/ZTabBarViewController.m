...
{
    if (ids && ![ids isKindOfClass:[NSNull class]]) {
        ModelPractice *modelP = [sqlite getLocalPlayPracticeDetailModelWithId:ids userId:[AppSetting getUserDetauleId]];
        if (modelP) {
...
{
    UIViewController *itemVC = [(ZRootViewController *)self.selectedViewController topViewController];
    if (itemVC) {
