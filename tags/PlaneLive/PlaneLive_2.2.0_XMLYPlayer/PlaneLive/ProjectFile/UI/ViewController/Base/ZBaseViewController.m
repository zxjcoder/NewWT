...
-(void)setShowPlayVC:(BOOL)animated
{
    ...
    if ([ZPlayerViewController sharedSingleton].arrayRawdata.count > 0) {
        ...
        switch (strPlayType.intValue) {
            ...
            {
                NSArray *arraySubscribeCurriculumPlay = [sqlite getLocalPlayListSubscribeCurriculumWithUserId:[AppSetting getUserDetauleId]];
            ...
            default:
            {
                NSArray *arrayPracticePlay = [sqlite getLocalPlayListPracticeWithUserId:[AppSetting getUserDetauleId]];
    ...
    if (array && array.count > 0 && array.count > index) {
        ...
        if (modelP && modelP.unlock == 1 && modelP.buyStatus == 0) {
            ...
            if (newArray.count > 0) {
                ...
                [sqlite setLocalPlayListPracticeWithArray:newArray userId:[AppSetting getUserDetauleId]];
...
-(void)showPlayVCWithCurriculumArray:(NSArray *)array index:(NSInteger)index
{
    ...
    if (array && array.count > 0 && array.count > index) {
        ...
        [sqlite setLocalPlayListSubscribeCurriculumWithArray:array userId:[AppSetting getUserDetauleId]];
