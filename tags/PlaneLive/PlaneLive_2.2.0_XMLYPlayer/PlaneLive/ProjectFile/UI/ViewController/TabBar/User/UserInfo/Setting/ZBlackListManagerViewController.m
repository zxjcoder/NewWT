...
-(void)setRefreshData:(BOOL)isSetState
{
    ...
    [snsV1 postGetBlackListWithUserId:[AppSetting getUserDetauleId] pageNum:self.pageNum resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
-(NSArray<UITableViewRowAction *> *)tableView:(UITableView *)tableView editActionsForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UITableViewRowAction *editRowAction = [UITableViewRowAction rowActionWithStyle:UITableViewRowActionStyleNormal
                                           ...
                                           {
                                               ModelUserBlack *model = [weakSelf.arrMain objectAtIndex:indexPath.row];
                                               [weakSelf setLastUserId:model.userId];
                                               [snsV1 postRemoveBlackListWithUserId:[AppSetting getUserDetauleId] removeUserId:model.userId resultBlock:nil errorBlock:nil];
                                               
                                               [weakSelf.arrMain removeObjectAtIndex:indexPath.row];
                                               [weakSelf.tvMain deleteRowsAtIndexPaths:@[indexPath] withRowAnimation:(UITableViewRowAnimationTop)];
