...
-(void)innerLocalData
{
    NSArray *arrayRecommend = [sqlite getLocalSeriesCoursesArrayWithUserId:[AppSetting getUserDetauleId]];
...
-(void)setRefreshHeader
{
    ...
    [snsV2 getCurriculumArrayWithPageNum:self.pageNum resultBlock:^(NSArray *arrResult, NSDictionary *result) {
        ...
        [sqlite setLocalSeriesCoursesWithArray:arrResult userId:[AppSetting getUserDetauleId]];
