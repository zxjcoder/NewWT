...
-(void)btnRightClick
{
    ...
    [snsV1 postCirclePublishQuestionWithUserId:[AppSetting getUserDetauleId] question:title quizDetail:content articles:[selTagId toString] resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
