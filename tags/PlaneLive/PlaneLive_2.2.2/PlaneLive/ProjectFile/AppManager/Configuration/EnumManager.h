...
typedef NS_ENUM(NSInteger, ZBackgroundState)
{
    ...
    ///实务无数据
    ZBackgroundStatePracticeNoData = 8,
    ///专栏无数据
    ZBackgroundStateSpecialColumnNoData = 9,
};
...
{
    ZUserInfoItemTVCQuestion = 1,
    ZUserInfoItemTVCAnswer = 2,
    ZUserInfoItemTVCComment = 3,
    ZUserInfoItemTVCFans = 4,
    ZUserInfoItemTVCFeedback = 5,
    ZUserInfoItemTVCServer = 6,
    ZUserInfoItemTVCAccount = 7,
    ZUserInfoItemTVCSetting = 8,
};
///网络状况
...
{
    ///最新
    ZPracticeTypeSortNew = 0,
    ///最热
    ZPracticeTypeSortHot = 1,
    ///推荐
    ZPracticeTypeSortRecommendation = 2,
};
