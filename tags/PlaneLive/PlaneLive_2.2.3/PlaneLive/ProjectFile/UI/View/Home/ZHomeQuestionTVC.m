...
-(void)innerInit
{
    ...
    self.viewHeader = [[ZHomeItemNavView alloc] initWithFrame:CGRectMake(0, 0, self.cellW, kZHomeItemNavViewHeight) title:kBoutiqueAsk];
    [self.viewHeader setAllTitleWithQuestionByMore];
    [self addSubview:self.viewHeader];
    
    self.tvMain = [[ZBaseTableView alloc] initWithFrame:CGRectMake(0, self.viewHeader.y+self.viewHeader.height-10, self.cellW, 0)];
