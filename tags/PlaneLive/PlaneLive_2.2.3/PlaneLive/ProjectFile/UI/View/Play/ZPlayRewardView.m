...
-(void)addPriceButton
{
    ...
    for (int i = 0; i < 6; i++) {
        ...
        [btnItem setTag:i];
        [[btnItem titleLabel] setFont:[ZFont systemFontOfSize:kFont_Min_Size]];
        ...
        switch (i) {
            case 1:
            {
                ...
                [btnItem setTitle:[NSString stringWithFormat:@"5%@", kPlaneMoney] forState:(UIControlStateNormal)];
                break;
            }
            case 2:
            {
                ...
                [btnItem setBackgroundColor:RGBCOLOR(243, 243, 243)];
                [btnItem setTitleColor:BLACKCOLOR forState:(UIControlStateNormal)];
                [btnItem setTitle:[NSString stringWithFormat:@"66%@", kPlaneMoney] forState:(UIControlStateNormal)];
                break;
            }
            case 3:
            {
                ...
                [btnItem setBackgroundColor:RGBCOLOR(243, 243, 243)];
                [btnItem setTitleColor:BLACKCOLOR forState:(UIControlStateNormal)];
                [btnItem setTitle:[NSString stringWithFormat:@"88%@", kPlaneMoney] forState:(UIControlStateNormal)];
                break;
            }
            case 4:
            {
                ...
                [btnItem setBackgroundColor:RGBCOLOR(243, 243, 243)];
                [btnItem setTitleColor:BLACKCOLOR forState:(UIControlStateNormal)];
                [btnItem setTitle:[NSString stringWithFormat:@"166%@", kPlaneMoney] forState:(UIControlStateNormal)];
                break;
            }
            case 5:
            {
                ...
                [btnItem setBackgroundColor:RGBCOLOR(243, 243, 243)];
                [btnItem setTitleColor:BLACKCOLOR forState:(UIControlStateNormal)];
                [btnItem setTitle:[NSString stringWithFormat:@"188%@", kPlaneMoney] forState:(UIControlStateNormal)];
                break;
            }
            default:
                ...
                [btnItem setTitle:[NSString stringWithFormat:@"2%@", kPlaneMoney] forState:(UIControlStateNormal)];
