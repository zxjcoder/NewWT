...
-(void)createImageView
{
    ...
    [self.lbSpeakerCompany setTextColor:DESCCOLOR];
    [self.lbSpeakerCompany setFont:[ZFont systemFontOfSize:kFont_Least_Size]];
...
{
    self.viewPractice = [[ZScrollView alloc] initWithFrame:CGRectMake(self.scrollViewMain.width, 0, self.scrollViewMain.width, self.scrollViewMain.height)];
...
{
    self.viewSubscribe = [[ZScrollView alloc] initWithFrame:CGRectMake(self.scrollViewMain.width, 0, self.scrollViewMain.width, self.scrollViewMain.height)];
...
-(void)setImageViewFrame
{
    ...
    CGFloat companyY = self.lbSpeakerName.y+self.lbSpeakerName.height+2;
    [self.lbSpeakerCompany setFrame:CGRectMake(kSizeSpace, companyY, lbW, 20)];
    ...
    CGFloat iconOY = self.lbSpeakerCompany.y+self.lbSpeakerCompany.height;
    CGFloat iconY = iconOY+(btnY-iconOY-iconSize)/2;
    [self.imgIcon setFrame:CGRectMake(iconX, iconY, iconSize, iconSize)];
    
    [self.btnText setFrame:CGRectMake(self.viewImage.width/2-btnW-8, btnY, btnW, btnH)];
    [self.btnPPT setFrame:CGRectMake(self.viewImage.width/2+8, btnY, btnW, btnH)];
}
