...
-(void)showAlbum
{
    if ([ZImagePickerController isSourceTypeAvailable: UIImagePickerControllerSourceTypePhotoLibrary]) {
        ...
        NSInteger maxImagesCount = kFeedbackPicturecMaxLength-self.imgMaxCount;
        ZAlbumBrowser *imagePickerVc = [[ZAlbumBrowser alloc] initWithMaxImagesCount:maxImagesCount delegate:self];
