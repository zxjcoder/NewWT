...
-(void)setRefreshData:(BOOL)isSetState
{
    ...
    [snsV1 postGetBlackListWithUserId:kLoginUserId pageNum:self.pageNum resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
-(NSArray<UITableViewRowAction *> *)tableView:(UITableView *)tableView editActionsForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UITableViewRowAction *editRowAction = [UITableViewRowAction rowActionWithStyle:UITableViewRowActionStyleNormal
                                                                           ...
                                                                           handler:^(UITableViewRowAction *action, NSIndexPath *indexPath)
                                           {
                                               ...
                                               [snsV1 postRemoveBlackListWithUserId:kLoginUserId removeUserId:model.userId resultBlock:nil errorBlock:nil];
