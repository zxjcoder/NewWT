 ...
 *  @param errorBlock   错误回调
 */
-(void)getLawFirmPracticeListWithLawFirmId:(NSString *)ids pageNum:(int)pageNum resultBlock:(void(^)(NSArray *result))resultBlock errorBlock:(void(^)(NSString *msg))errorBlock
{
    NSMutableDictionary *dicParam = [NSMutableDictionary dictionary];
    if (ids) {
        [dicParam setObject:ids forKey:@"id"];
 ...
 *  @param errorBlock   错误回调
 */
-(void)getLawFirmSubscribeListWithLawFirmId:(NSString *)ids pageNum:(int)pageNum resultBlock:(void(^)(NSArray *result))resultBlock errorBlock:(void(^)(NSString *msg))errorBlock
{
    NSMutableDictionary *dicParam = [NSMutableDictionary dictionary];
    if (ids) {
        [dicParam setObject:ids forKey:@"id"];
 ...
 *  @param errorBlock   错误回调
 */
-(void)getLawFirmSeriesCourseListWithLawFirmId:(NSString *)ids pageNum:(int)pageNum resultBlock:(void(^)(NSArray *result))resultBlock errorBlock:(void(^)(NSString *msg))errorBlock
{
    NSMutableDictionary *dicParam = [NSMutableDictionary dictionary];
    if (ids) {
        [dicParam setObject:ids forKey:@"id"];
