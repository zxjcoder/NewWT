...
-(void)innerInit
{
    ...
    [self.btnPlay setImage:[SkinManager getImageWithName:@"play"] forState:(UIControlStateHighlighted)];
...
-(void)setStartPlay
{
    ...
    [self.btnPlay setImage:[SkinManager getImageWithName:@"play_stop"] forState:(UIControlStateNormal)];
    [self.btnPlay setImage:[SkinManager getImageWithName:@"play_stop"] forState:(UIControlStateHighlighted)];
}
/// 设置总时长
