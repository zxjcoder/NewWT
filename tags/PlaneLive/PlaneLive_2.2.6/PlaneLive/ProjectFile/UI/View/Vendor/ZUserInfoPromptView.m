...
-(void)innerInit
{
    ...
    [self.lbName setText:kMySteriousPerson];
    ...
    [self.lbDesc setText:kYourPersonalInformationIsTooLittle];
    ...
    [self.btnSubmit setTitle:kPerfectImmediately forState:(UIControlStateNormal)];
    ...
    [self.btnCancel setTitle:kNoLongerUpdating forState:(UIControlStateNormal)];
