...
-(void)innerInit
{
    ...
    [[self.btnHot titleLabel] setFont:[ZFont systemFontOfSize:kFont_Default_Size]];
    ...
    [[self.btnDynamic titleLabel] setFont:[ZFont systemFontOfSize:kFont_Default_Size]];
    ...
    [[self.btnNew titleLabel] setFont:[ZFont systemFontOfSize:kFont_Default_Size]];
    ...
    [[self.btnAtt titleLabel] setFont:[ZFont systemFontOfSize:kFont_Default_Size]];
