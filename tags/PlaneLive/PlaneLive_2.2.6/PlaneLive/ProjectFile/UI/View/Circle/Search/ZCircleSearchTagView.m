...
-(void)setViewFrame
{
    ...
    CGFloat tagnameY = self.height/2-30/2;
    CGFloat tagnameX = self.imgLogo.x+logoSize+10;
    [self.viewTagName setFrame:CGRectMake(tagnameX, tagnameY, tagW, 30)];
...
-(void)setViewDataWithModel:(ModelTag *)model
{
    ...
    if (model) {
        ...
        [self.imgLogo setImageURLStr:model.tagLogo placeImage:[SkinManager getDefaultPhoto]];
    }
    [self setViewFrame];
}
