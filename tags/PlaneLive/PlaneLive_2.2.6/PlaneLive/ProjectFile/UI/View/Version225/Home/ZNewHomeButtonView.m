...
-(void)innerInit:(NSString *)title desc:(NSString *)desc isMore:(BOOL)isMore
{
    ...
    if (isMore) {
        ...
        if (!self.btnAll) {
            ...
            UIImageView *imageIcon = [[UIImageView alloc] initWithFrame:CGRectMake(self.btnAll.width-15, self.btnAll.height-22, 24, 24)];
...
{
    UILabel *lbTitle = [[UILabel alloc] initWithFrame:(CGRectMake(20, 15, 10, 20))];
