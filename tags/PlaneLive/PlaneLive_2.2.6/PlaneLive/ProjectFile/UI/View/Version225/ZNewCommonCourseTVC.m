...
@implementation ZNewCommonCourseTVC
...
-(void)innerInit
{
    ...
    self.cellH = [ZNewCommonCourseTVC getH];
...
{
    self.cellH = [ZNewCommonCourseTVC getPracticeH];
...
{
    self.cellH = [ZNewCommonCourseTVC getCourseH];
