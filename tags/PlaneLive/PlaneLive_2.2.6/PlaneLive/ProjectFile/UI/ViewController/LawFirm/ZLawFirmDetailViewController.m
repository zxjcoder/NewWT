...
-(void)innerInit
{
    ...
    [self.tvcDetail setOnViewHeightChange:^(CGFloat viewH) {
        weakSelf.tvMain.sectionHeaderHeight = viewH;
    ...
    self.tvMain = [[ZBaseTableView alloc] initWithFrame:VIEW_MAIN_FRAME style:UITableViewStyleGrouped];
