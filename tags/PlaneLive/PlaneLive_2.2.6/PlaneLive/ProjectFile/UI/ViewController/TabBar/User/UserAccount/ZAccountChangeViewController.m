//
//  ZAccountChangeViewController.m
//  PlaneLive
//
...
@interface ZAccountChangeViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ZAccountChangeViewController
...
- (void)viewDidLoad
{
    ...
    [self setTitle:kMyMobilePhoneNumberChange];
...
-(void)btnSaveClick
{
    ...
    ZWEAKSELF
    [ZProgressHUD showMessage:kChanging];
    [snsV2 postChangeMobileNumberWithMobile:phone password:pwd valiCode:code resultBlock:^(NSDictionary *result) {
        ...
        [ZAlertPromptView showWithMessage:kChangePhoneSuccess buttonText:kToRecharge completionBlock:^{
...
-(void)btnSendCodeClick
{
    ...
    [snsV1 postGetCodeWithAccount:account flag:5 resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
            [ZProgressHUD dismiss];
