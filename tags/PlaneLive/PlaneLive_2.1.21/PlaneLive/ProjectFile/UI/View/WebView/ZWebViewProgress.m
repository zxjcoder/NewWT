...
const float ZInitialProgressValue = 0.1f;
const float ZInteractiveProgressValue = 0.5f;
const float ZFinalProgressValue = 0.9f;

@implementation ZWebViewProgress
{
...
- (void)startProgress
{
    if (_progress < ZInitialProgressValue) {
        [self setProgress:ZInitialProgressValue];
    }
}
...
- (void)incrementProgress
{
    ...
    float maxProgress = _interactive ? ZFinalProgressValue : ZInteractiveProgressValue;
