...
/// 团队名称
@property (strong, nonatomic) ZSubscribeDetailTextTVC *tvcTeamName;
/// 团队介绍
...
-(void)innerInit
{
    ...
    self.tvcTeamName = [[ZSubscribeDetailTextTVC alloc] initWithReuseIdentifier:@"tvcTeamName" type:(ZSubscribeDetailTextTVCTypeTeamName)];
...
-(void)setViewDataWithModel:(ModelSubscribeDetail *)model
{
    ...
    [self.tvcTeamName setCellDataWithModel:model];
