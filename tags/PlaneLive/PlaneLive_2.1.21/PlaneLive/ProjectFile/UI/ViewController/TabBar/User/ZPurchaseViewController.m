...
-(void)innerInit
{
    ...
    self.scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, scViewY, APP_FRAME_WIDTH, APP_FRAME_HEIGHT-scViewY)];
...
-(void)setRefreshHeaderSubscribe
{
    ...
    [snsV2 getPurchaseSubscribeArrayWithPageNum:weakSelf.pageNumberSubscribe resultBlock:^(NSArray *array, NSDictionary *result) {
...
{
    ZWEAKSELF
    [snsV2 getPurchasePracticeArrayWithPageNum:weakSelf.pageNumberPractice+1 resultBlock:^(NSArray *array, NSDictionary *result) {
...
{
    ZWEAKSELF
    [snsV2 getPurchaseSubscribeArrayWithPageNum:weakSelf.pageNumberSubscribe+1 resultBlock:^(NSArray *array, NSDictionary *result) {
