...
@interface ZZoomingScrollView()

@property (nonatomic, weak) id photoBrowser;
...
@implementation ZZoomingScrollView
...
- (id)initWithPrePhotoBrowser:(ZPhotoBrowser *)browser
{
    if ((self = [super init])) {
        ...
        _progressView.trackTintColor    = browser.trackTintColor    ? [(ZPhotoBrowser*)self.photoBrowser trackTintColor]    : [UIColor colorWithWhite:0.2 alpha:1];
        _progressView.progressTintColor = browser.progressTintColor ? [(ZPhotoBrowser*)self.photoBrowser progressTintColor] : [UIColor colorWithWhite:1.0 alpha:1];
...
- (id)initWithPhotoBrowser:(IDMPhotoBrowser *)browser {
    if ((self = [super init])) {
        ...
        _progressView.thicknessRatio = 0.1;
        _progressView.roundedCorners = NO;
        _progressView.trackTintColor    = browser.trackTintColor    ? [(IDMPhotoBrowser*)self.photoBrowser trackTintColor]    : [UIColor colorWithWhite:0.2 alpha:1];
        _progressView.progressTintColor = browser.progressTintColor ? [(IDMPhotoBrowser*)self.photoBrowser progressTintColor] : [UIColor colorWithWhite:1.0 alpha:1];
        [self addSubview:_progressView];
...
- (void)layoutSubviews {
    ...
    [_progressView setFrame:CGRectMake((screenWidth-35.)/2., (screenHeight-35.)/2, 35.0f, 35.0f)];
