...
@interface AppDelegate ()<SKStoreProductViewControllerDelegate,WXApiDelegate,ZAlertViewDelegate,UNUserNotificationCenterDelegate>
...
{
#ifdef DEBUG
    [UMessage startWithAppkey:kUMeng_Appkey launchOptions:launchOptions httpsEnable:NO];
...
-(void)setRefreshAppConfig
{
    if (!self.isCheckVersion) {
        ...
        [snsV1 getAppConfigWithAppVersion:APP_PROJECT_VERSION resultBlock:^(ModelAppConfig *currentVersion, ModelAppConfig *newVersion) {
            if (currentVersion) {
