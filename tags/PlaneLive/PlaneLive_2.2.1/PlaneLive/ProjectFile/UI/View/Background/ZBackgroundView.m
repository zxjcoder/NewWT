...
-(void)setViewStateWithState:(ZBackgroundState)state
{
    ...
    switch (state) {
        ...
        case ZBackgroundStateFail:
        {
            [self initImageView];
            [self initButton];
            [self.imgLogo setImage:[SkinManager getImageWithName:@"icon_fail_bg"]];
        ...
        case ZBackgroundStateLoginNull:
        {
            [self initImageView];
            [self initButton];
            [self.imgLogo setImage:[SkinManager getImageWithName:@"icon_nologin_bg"]];
        ...
        {
            [self initImageView];
            [self.imgLogo setImage:[SkinManager getImageWithName:@"icon_subscribe_bg"]];
            break;
        }
        case ZBackgroundStateSpecialColumnNoData:
        {
            [self initImageView];
            [self.imgLogo setImage:[SkinManager getImageWithName:@"icon_specialcolumn_bg"]];
            break;
        }
        case ZBackgroundStateCurriculumNoData:
        {
            [self initImageView];
            [self.imgLogo setImage:[SkinManager getImageWithName:@"icon_curriculum_bg"]];
            break;
        }
        case ZBackgroundStatePracticeNoData:
        {
            [self initImageView];
            [self.imgLogo setImage:[SkinManager getImageWithName:@"icon_practice_bg"]];
            break;
        }
        case ZBackgroundStateNullNoButton:
        {
            [self initImageView];
            [self.imgLogo setImage:[SkinManager getImageWithName:@"icon_nodata_bg"]];
            break;
...
-(void)setViewFrame
{
    ...
    if (self.viewState == (ZBackgroundStateSubscribeNoData)) {
        imgY = 80;
    }
    if (self.imgLogo) {
