...
-(void)innerInit
{
    ...
    switch (self.type) {
        case ZUserInfoItemTVCQuestion:
        {
            ...
            [self.lbTitle setText:kMyAnswerQuestion];
            break;
        }
        ...
        case ZUserInfoItemTVCServer:
        {
            ...
            [self.lbTitle setText:kCustomerService];
            break;
        }
        case ZUserInfoItemTVCAccount:
        {
            [self.imgIcon setImageName:@"my_persion_account_new"];
            [self.lbTitle setText:[NSString stringWithFormat:@"%@%@", kIndividual, kAccount]];
            break;
        }
...
-(CGFloat)setCellDataWithModel:(ModelUser *)model
{
    ...
    switch (self.type) {
        ...
        {
            [self.lbCount setHidden:NO];
            //[self.lbCount setHidden:model.myReplyCount==0];
            [self.lbCount setText:[NSString stringWithFormat:@"%d", model.myReplyCount]];
            break;
        }
        case ZUserInfoItemTVCFans:
        {
