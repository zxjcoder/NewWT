...
-(void)innerInit
{
    CGFloat btnY = 10;
    CGFloat btnW = 60;
    CGFloat btnH = self.height-btnY*2-6;
    CGFloat itemW = self.width/3;
    
    self.btnItem1 = [[ZButton alloc] initWithText:kClassicPractice imageName:@"classic_practice_icon"];
    ...
    self.btnItem2 = [[ZButton alloc] initWithText:kPopularSubscription imageName:@"hot_subscription_icon"];
    ...
    self.btnItem3 = [[ZButton alloc] initWithText:kSeriesCourse imageName:@"series_courses_icon"];
