...
//Practice_List_Item_PlayTime,实务->每期播放时长,1
#define kEvent_Practice_List_Item_PlayTime @"Practice_List_Item_PlayTime"
//Practice_ID,实务->ID->ID,0
#define kEvent_Practice_List_Item_ID @"Practice_ID"
//Practice_Name,实务->名称->Name,0
#define kEvent_Practice_List_Item_Name @"Practice_Name"
//Practice_Type,实务->类型->Type,0
#define kEvent_Practice_List_Item_Type @"Practice_Type"
//Practice_Type,实务->时长->Time,0
#define kEvent_Practice_List_Item_Time @"Practice_Time"
//Practice_Type,实务->用户->User,0
#define kEvent_Practice_List_Item_User @"Practice_User"
...
//User_MYPay,我的->消费记录,0
#define kEvent_User_MYPay @"User_MYPay"
//User_MYPay,我的->购物车,0
#define kEvent_User_MYShopChat @"User_MYShopChat"
//User_MYPay,我的->账号管理,0
#define kEvent_User_MYAccountManager @"User_MYAccountManager"
//User_MYPay,我的->下载管理,0
#define kEvent_User_MYDownload @"User_MYDownload"
//User_MYBalance,我的->余额查询,0
#define kEvent_User_MYBalance @"User_MYBalance"
...
//User_TaskCenter,我的->任务中心,0
#define kEvent_User_TaskCenter @"User_TaskCenter"
