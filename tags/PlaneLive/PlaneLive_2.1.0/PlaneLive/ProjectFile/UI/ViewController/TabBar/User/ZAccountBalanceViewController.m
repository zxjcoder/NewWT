...
-(void)innerInit
{
    ...
    [self.viewMain setOnRechargeClick:^(NSString *money) {
        ...
        [snsV2 getGenerateOrderWithMoney:money type:WTPayTypeRecharge objid:nil title:title payType:(WTPayWayTypeBalance) resultBlock:^(ModelOrderWT *model, id resultThree, NSDictionary *result) {
