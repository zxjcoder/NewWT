...
@implementation ZTaskCompleteView
...
-(void)innerInit
{
    ...
    self.imgIcon = [[UIImageView alloc] initWithImage:[SkinManager getImageWithName:@"task_alertview_complete_icon"]];
    [self.viewContent addSubview:self.imgIcon];
    
    self.lbContent = [[UILabel alloc] init];
    [self.lbContent setText:kCongratulationsCompleteTheTask];
    ...
    [self.btnSubmit setTitle:kReturnToPractice forState:(UIControlStateNormal)];
