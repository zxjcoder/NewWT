...
//    [self.lbNickName setFrame:nickNameFrame];
    ...
    CGFloat titleY = kSize10;//self.imgPhoto.y+self.imgPhoto.height+kSize8;
...
-(CGFloat)setCellDataWithModel:(ModelMyAllQuestion *)model
{
    [self setModel:model];
    ...
    NSString *content = self.model.aContent.imgReplacing;
