...
-(void)btnRightClick
{
    ...
    if (bePracticeId.length > 0) {
        ...
        [snsV1 postCirclePublishQuestionWithUserId:[AppSetting getUserDetauleId] question:title quizDetail:content articles:nil speechId:bePracticeId resultBlock:^(NSDictionary *result) {
            GCDMainBlock(^{
                ...
                if (weakSelf.preVC != nil) {
                    [weakSelf.navigationController popToViewController:weakSelf.preVC animated:YES];
                } else {
