...
-(void)innerInit
{
    ...
    if (!self.lbTitle) {
        self.lbTitle = [[ZLabel alloc] initWithFrame:(CGRectMake(0, 20, self.viewContent.width, 20))];
    ...
    CGFloat mainHeight = self.contentH-mainY-36;
    ...
    self.closeFrame = CGRectMake(0, self.tvMain.y+self.tvMain.height, self.viewContent.width, 36);
    if (!self.viewClose) {
