...
@interface ZNewHomeSeriesView()<UITableViewDelegate, UITableViewDataSource>
...
@implementation ZNewHomeSeriesView
...
-(void)innerInit
{
    ...
    self.viewTop = [[ZNewHomeButtonView alloc] initWithTitle:kWonderfulSeries desc:kWhatIsSeriesOfLessons isMore:true];
