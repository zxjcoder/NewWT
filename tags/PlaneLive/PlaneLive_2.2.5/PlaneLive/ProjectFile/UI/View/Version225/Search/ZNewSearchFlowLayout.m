...
#import "ZNewSearchFlowLayout.h"

@interface ZNewSearchFlowLayout()

@property (strong, nonatomic) NSCache *cache;

@end

@implementation ZNewSearchFlowLayout

- (void)setAlignment:(ZNewSearchFlowAlignment)alignment
{
...
- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    if (self.alignment == ZNewSearchFlowAlignmentJustyfied) {
        return attributes;
    }
    ...
    for (UICollectionViewLayoutAttributes *item in itemsInRow) {
        ...
        if (CGRectIsEmpty(rect)) {
            switch (self.alignment) {
                case ZNewSearchFlowAlignmentLeft:
                    x = self.sectionInset.left;
                    break;
                case ZNewSearchFlowAlignmentCenter:
                    x = (width - totalWidth) / 2.0f;
                    break;
                case ZNewSearchFlowAlignmentRight:
