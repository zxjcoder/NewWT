...
-(void)innerInit
{
    ...
    self.lbTitle = [[UILabel alloc] initWithFrame:(CGRectMake(self.imgIcon.x + self.imgIcon.width + 15, self.cellH / 2 - self.lbH / 2, 100, self.lbH))];
    ...
    CGFloat countW = 100;
    CGFloat countX = self.cellW-countW-self.space-15;
    CGFloat countY = self.cellH / 2 - self.lbMinH / 2;
    self.lbCount = [[UILabel alloc] initWithFrame:(CGRectMake(countX, countY, countW, self.lbMinH))];
    ...
    self.lbDesc = [[UILabel alloc] initWithFrame:(CGRectMake(countX, countY, countW, self.lbMinH))];
