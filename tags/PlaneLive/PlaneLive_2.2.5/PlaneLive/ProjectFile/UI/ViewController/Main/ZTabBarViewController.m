...
-(void)setShowLoginVCWithAnimated:(BOOL)animated
{
    ...
    //[itemVC setModalTransitionStyle:UIModalTransitionStyleFlipHorizontal];
    ...
    [itemRVC setModalTransitionStyle:UIModalTransitionStyleCoverVertical];
...
-(void)setShowSearchPractice
{
    ...
    [(ZHomeViewController *)[(ZRootViewController *)self.selectedViewController topViewController] setShowSearchPractice];
}
///注销登录
-(void)logout
{
