...
-(void)btnRightClick
{
    ...
    [snsV1 postCircleUpdateQuestionWithUserId:kLoginUserId questionId:self.modelQD.ids question:newTitle quizDetail:newContent articles:strTpoicArr resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
