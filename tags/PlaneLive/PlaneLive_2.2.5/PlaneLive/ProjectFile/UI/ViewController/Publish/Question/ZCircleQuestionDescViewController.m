...
-(void)btnRightClick
{
    ...
    if (bePracticeId.length > 0) {
        ...
        [snsV1 postCirclePublishQuestionWithUserId:kLoginUserId question:title quizDetail:content articles:nil speechId:bePracticeId resultBlock:^(NSDictionary *result) {
            GCDMainBlock(^{
