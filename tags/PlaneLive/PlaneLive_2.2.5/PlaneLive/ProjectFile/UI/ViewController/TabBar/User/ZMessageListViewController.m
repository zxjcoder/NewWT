...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [StatisticsManager eventIOBeginPageWithName:kZhugeIOPageUserMessageCenterKey];
}
- (void)viewWillDisappear:(BOOL)animated
{
    [super viewWillDisappear:animated];
    
    [StatisticsManager eventIOEndPageWithName:kZhugeIOPageUserMessageCenterKey dictionary:nil];
}
...
-(void)setRefreshHeader
{
    ...
    self.isLoaded = true;
    ZWEAKSELF
    [snsV2 getMyMessageArrayWithPageNum:1 resultBlock:^(NSArray *arrResult, NSDictionary *result) {
        weakSelf.pageNum = 1;
...
{
    ZWEAKSELF
    [ZAlertPromptView showWithMessage:kAreYouSureYouWantToDeleteThisMessage completionBlock:^{
