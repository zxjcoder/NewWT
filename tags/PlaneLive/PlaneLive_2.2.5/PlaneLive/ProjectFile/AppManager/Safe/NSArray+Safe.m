...
+ (void)load
{
    ...
    [NSClassFromString(@"__NSArrayI") swapClassMethod:@selector(objectAtIndex:)
                                        currentMethod:@selector(ls_objectAtIndex:)];
    
    [NSClassFromString(@"__NSArray0") swapClassMethod:@selector(objectAtIndex:)
                                        currentMethod:@selector(ls_zeroObjectAtIndex:)];
    
    [NSClassFromString(@"__NSSingleObjectArrayI") swapClassMethod:@selector(objectAtIndex:)
...
+ (void)load
{
    [NSClassFromString(@"__NSArrayM") swapClassMethod:@selector(objectAtIndex:)
                                        currentMethod:@selector(ls_objectAtIndex:)];
    
    [NSClassFromString(@"__NSArrayM") swapClassMethod:@selector(addObject:)
                                        currentMethod:@selector(ls_addObject:)];
    
    [NSClassFromString(@"__NSArrayM") swapClassMethod:@selector(removeObjectAtIndex:)
                                        currentMethod:@selector(ls_removeObjectAtIndex:)];
    
    [NSClassFromString(@"__NSArrayM") swapClassMethod:@selector(replaceObjectAtIndex:withObject:)
                                        currentMethod:@selector(ls_replaceObjectAtIndex:withObject:)];
    
    [NSClassFromString(@"__NSArrayM") swapClassMethod:@selector(removeObjectsInRange:)
                                        currentMethod:@selector(ls_removeObjectsInRange:)];
    
    [NSClassFromString(@"__NSArrayM") swapClassMethod:@selector(insertObject:atIndex:)
