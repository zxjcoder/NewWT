...
- (void)XMTrackDownloadDidFailed:(XMTrack *)track
{
    ...
    GBLog(@"TrackDownloadDidFailed: trackId: %@,  trackTitle: %@,  announcerId: %ld,  subordinatedAlbumId: %@", trackId, track.trackTitle, (long)track.announcer.id, albumId);
...
- (void)XMTrackDownloadDidFinished:(XMTrack *)track
{
    ...
    GBLog(@"TrackDownloadDidFinished: trackId: %@,  trackTitle: %@,  announcerId: %ld,  subordinatedAlbumId: %@", trackId, track.trackTitle, (long)track.announcer.id, albumId);
...
- (void)XMTrackDownloadDidBegan:(XMTrack *)track
{
    ...
    GBLog(@"TrackDownloadDidBegan: trackId: %@,  trackTitle: %@,  announcerId: %ld,  subordinatedAlbumId: %@", trackId, track.trackTitle, (long)track.announcer.id, albumId);
...
- (void)XMTrackDownloadDidCanceled:(XMTrack *)track
{
    ...
    GBLog(@"TrackDownloadDidCanceled: trackId: %@,  trackTitle: %@,  announcerId: %ld,  subordinatedAlbumId: %@", trackId, track.trackTitle, (long)track.announcer.id, albumId);
...
- (void)XMTrackDownloadDidPaused:(XMTrack *)track
{
    ...
    GBLog(@"TrackDownloadDidPaused: trackId: %@,  trackTitle: %@,  announcerId: %ld,  subordinatedAlbumId: %@", trackId, track.trackTitle, (long)track.announcer.id, albumId);
...
- (void)XMTrack:(XMTrack *)track updateDownloadedPercent:(double)downloadedPercent
{
    ...
    GBLog(@"TrackUpdateDownloadedPercent: trackId: %@,  trackTitle: %@,  announcerId: %ld,  subordinatedAlbumId: %@,  updateDownloadedPercent: %.lf", trackId, track.trackTitle, (long)track.announcer.id, albumId, downloadedPercent);
}
///下载状态更新为ready时被调用
- (void)XMTrackDownloadStatusUpdated:(XMTrack *)track
{
    ...
    GBLog(@"TrackDownloadStatusUpdated: trackId: %@,  trackTitle: %@,  announcerId: %ld,  subordinatedAlbumId: %@", trackId, track.trackTitle, (long)track.announcer.id, albumId);
...
- (void)XMTrackDownloadDidLoadFromDB
{
    ...
    GBLog(@"TrackDownloadDidLoadFromDB");
}
