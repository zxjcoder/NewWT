...
//是否默认宽度
#define IsIPhoneDefaultW (APP_FRAME_WIDTH == 320)
//是否IPhone4
#define IsIPhone4 (APP_FRAME_WIDTH == 320 && APP_FRAME_HEIGHT == 480)
//是否IPhoneX
#define IsIPhoneX (APP_FRAME_WIDTH == 375 && APP_FRAME_HEIGHT == 812)
...
//TABBAR高度
#define APP_TABBAR_HEIGHT (IsIPhoneX ? 83 : 49)
