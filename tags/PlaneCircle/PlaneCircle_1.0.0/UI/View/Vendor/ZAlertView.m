...
{
    ZAlertView *alertView = [[ZAlertView alloc] initWithTitle:kPrompt message:message buttonTitles:kDone, nil];
...
{
    ZAlertView *alertView = [[ZAlertView alloc] initWithTitle:kPrompt message:message buttonTitles:kCancel,kDone, nil];
    [alertView setAlertViewStyle:(ZAlertViewStyleDefault)];
    [alertView showWithCompletion:^(ZAlertView *alertView, NSInteger selectIndex) {
...
{
    ZAlertView *alertView = [[ZAlertView alloc] initWithTitle:title message:message buttonTitles:kCancel,kDone, nil];
    [alertView setAlertViewStyle:(ZAlertViewStyleDefault)];
    [alertView showWithCompletion:^(ZAlertView *alertView, NSInteger selectIndex) {
        if (selectIndex == 1 && doneCompletion) {
            doneCompletion();
