...
-(void)innerInit
{
    ...
    [[self.btnAgree titleLabel] setFont:[UIFont systemFontOfSize:kFont_Small_Size]];
...
-(void)layoutSubviews
{
    ...
    [self.lbSign setFrame:CGRectMake(lbX, self.cellH/2+3, lbW+btnW, self.lbMinH)];
    
    [self.btnAgree setFrame:CGRectMake(btnX, self.space, btnW, btnH)];
