...
-(void)innerInit
{
    ...
    [self.lbDesc setFont:[UIFont systemFontOfSize:kFont_Default_Size]];
    ...
    [[self.btnUpd titleLabel] setFont:[UIFont systemFontOfSize:kFont_Small_Size]];
...
-(void)setViewDataWithModel:(ModelEntity *)model
{
    ...
    if (model) {
        if ([model isKindOfClass:[ModelRankCompany class]]) {
            ...
            [self.imgLogo setImageURLStr:modelRU.operator_img placeImage:[SkinManager getImageWithName:@"new_user_photo"]];
