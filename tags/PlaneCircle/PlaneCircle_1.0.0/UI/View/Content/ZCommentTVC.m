...
-(void)setViewFrame
{
    ...
    CGRect contentFrame = CGRectMake(rightX, self.lbNickName.y+self.lbNickName.height+8, rightW, 0);
    ...
    if (self.isDefaultH) {
        ...
        [self.btnMax setHidden:contentH < 84];
    } else {
    ...
    if (btnH == 0) {
        self.cellH = self.btnMax.y+self.btnMax.height+8;
    } else {
       self.cellH = self.btnMax.y+self.btnMax.height;
    }
