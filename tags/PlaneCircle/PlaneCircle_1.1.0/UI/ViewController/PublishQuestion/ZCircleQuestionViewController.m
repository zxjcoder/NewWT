...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (self.modelQuestion && self.modelQuestion.title.length == 0) {
        NSString *localTitle = [sqlite getSysParamWithKey:kSQLITE_LAST_QUESTION_TITLE];
        [self.modelQuestion setTitle:localTitle];
    }
