...
-(void)innerData
{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        NSString *rankPath = [AppSetting getRankFilePath];
        ...
        float rankSize = [self folderSizeAtPath:rankPath];
        ...
        float fileSize = userSize + recvSize + rankSize + headSize + audioSize + answerSize + webKitSize;
