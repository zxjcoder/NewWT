...
-(void)btnWeChatClick
{
    ...
    [[AppDelegate app] setOpenUrlType:WTOpenURLTypeWechat];
...
-(void)btnQQClick
{
    ...
    [[AppDelegate app] setOpenUrlType:WTOpenURLTypeTencent];
    ...
    [ShareSDK authorize:type settings:nil onStateChanged:^(SSDKResponseState state, SSDKUser *user, NSError *error) {
        switch (state) {
            case SSDKResponseStateSuccess:
            {
                ...
                int flag = 1;
                switch (type) {
                    case SSDKPlatformTypeWechat: flag = 1; break;
                    case SSDKPlatformTypeQQ: flag = 3; break;
                    case SSDKPlatformTypeSinaWeibo: flag = 2; break;
                    default: break;
                }
