...
-(void)setCellFontSize
{
    ...
    [self.lbContent setFont:[UIFont systemFontOfSize:kSet_Font_Least_Size(self.fontSize)]];
}
-(void)setViewFrame
{
    [self setCellFontSize];
    ...
    [self.lbContent setFrame:CGRectMake(self.space, self.viewQuestion.y+self.viewQuestion.height+8, rightW, 0)];
    ///有描述
    ...
    [self.viewLine setFrame:CGRectMake(0, self.lbContent.y+self.lbContent.height+5, self.cellW, self.lineMaxH)];
