...
-(void)innerInit
{
    ...
    [self.lbQuestionTitle setFont:[UIFont boldSystemFontOfSize:kFont_Middle_Size]];
...
{
    CGFloat imgS = 25;
    [self.imgView setFrame:CGRectMake(self.space, self.space, imgS, imgS)];
    ...
    CGRect titleFrame = CGRectMake(self.space, self.imgView.y+imgS+13, self.cellW-self.space*2, self.lbH);
    ...
    [self.viewLine setFrame:CGRectMake(0, self.lbQuestionTitle.y+newH+15, self.cellW, self.lineMaxH)];
