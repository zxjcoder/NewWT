...
-(void)innerInit
{
    ...
    [self.lbAgreeTitle setFont:[UIFont systemFontOfSize:kFont_Min_Size]];
    ...
    [self.lbAgreeCount setFont:[UIFont systemFontOfSize:kFont_Middle_Size]];
    ...
    [self.lbShareTitle setFont:[UIFont systemFontOfSize:kFont_Min_Size]];
    ...
    [self.lbShareCount setFont:[UIFont systemFontOfSize:kFont_Middle_Size]];
    ...
    [self.lbCollectionTitle setFont:[UIFont systemFontOfSize:kFont_Min_Size]];
    ...
    [self.lbCollectionCount setFont:[UIFont systemFontOfSize:kFont_Middle_Size]];
