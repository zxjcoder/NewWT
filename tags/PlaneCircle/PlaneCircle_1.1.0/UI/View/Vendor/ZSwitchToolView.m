...
-(void)innerInit
{
    ...
    switch (self.type) {
        ...
        case ZSwitchToolViewItemMyQuestion:
        {
            ...
            [self.btnItem2 setTitle:@"新答案" forState:(UIControlStateNormal)];
            break;
        }
...
-(void)createLabelCount
{
    ...
    [self.lbCount setFont:[UIFont systemFontOfSize:10]];
...
-(void)createButtonItem1
{
    ...
    [[self.btnItem1 titleLabel] setFont:[UIFont systemFontOfSize:kFont_Middle_Size]];
...
-(void)createButtonItem2
{
    ...
    [[self.btnItem2 titleLabel] setFont:[UIFont systemFontOfSize:kFont_Middle_Size]];
...
-(void)createButtonItem3
{
    ...
    [[self.btnItem3 titleLabel] setFont:[UIFont systemFontOfSize:kFont_Middle_Size]];
...
-(void)createButtonItem4
{
    ...
    [[self.btnItem4 titleLabel] setFont:[UIFont systemFontOfSize:kFont_Middle_Size]];
...
-(void)layoutSubviews
{
    ...
    switch (self.type) {
        ...
        case ZSwitchToolViewItemMyQuestion:
        {
            ...
            [self.lbCount setFrame:CGRectMake(self.btnItem2.x+self.btnItem2.width/2+30, countY, countS, countS)];
            break;
        }
        case ZSwitchToolViewItemMyAnswer:
        {
