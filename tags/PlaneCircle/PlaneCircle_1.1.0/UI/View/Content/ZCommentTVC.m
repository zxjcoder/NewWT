...
-(void)innerInit
{
    ...
    [self.lbCommentTime setFont:[UIFont systemFontOfSize:kFont_Min_Size]];
    ...
    [self.lbCommentContent setFont:[UIFont systemFontOfSize:kFont_Small_Size]];
...
-(void)setViewFrame
{
    ...
    if (self.isDefaultH) {
        CGFloat maxH = [[ZCalculateLabel shareCalculateLabel] getMaxLineHeightWithLabel:self.lbCommentContent line:4];
...
-(void)setCellDataWithModel:(ModelComment *)model
{
