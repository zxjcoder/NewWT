...
-(void)innerInit
{
    ...
    [[self.btnAgree titleLabel] setFont:[UIFont systemFontOfSize:kFont_Least_Size]];
...
-(void)layoutSubviews
{
    ...
    [self.lbSign setFrame:CGRectMake(lbX, self.lbNickName.y+self.lbNickName.height+3, lbW+btnW, self.lbMinH)];
