...
-(void)innerInit
{
    ...
    [self.lbAttIcon setFont:[UIFont systemFontOfSize:kFont_Small_Size]];
    ...
    [self.lbAnswerIcon setFont:[UIFont systemFontOfSize:kFont_Small_Size]];
    ...
    [[self.btnAtt titleLabel] setFont:[UIFont systemFontOfSize:kFont_Middle_Size]];
