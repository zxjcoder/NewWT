...
//@"^1(3|5|6|7|8|9)\\d{9}$"
#define kPredicate_Mobile @"^(0|86|17951)?(13[0-9]|15[0-9]|18[0-9]|19[0-9]|17[0-9]|14[0-9])[0-9]{8}$"
...
#define kPredicate_NickName @"^([\u4e00-\u9fa5]{1,12})|[a-zA-Z_0-9]{1,12}|[\u4E00-\u9FA5A-Za-z0-9_.]{1,12}$"
