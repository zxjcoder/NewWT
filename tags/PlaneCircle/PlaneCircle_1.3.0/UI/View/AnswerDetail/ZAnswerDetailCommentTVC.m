...
-(void)innerInit
{
    ...
    [self.btnCommentMax setTitle:@"展开" forState:(UIControlStateNormal)];
    [self.btnCommentMax setTitle:@"展开" forState:(UIControlStateHighlighted)];
    ...
    [self.btnReplyMax setTitle:@"展开" forState:(UIControlStateNormal)];
    [self.btnReplyMax setTitle:@"展开" forState:(UIControlStateHighlighted)];
...
-(void)setCellIsCommentDefaultH:(BOOL)isDF
{
    ...
    if (self.isCommentDefaultH) {
        ...
        [self.btnCommentMax setTitle:@"收起" forState:(UIControlStateNormal)];
        [self.btnCommentMax setTitle:@"收起" forState:(UIControlStateHighlighted)];
    }
}
...
-(void)setCellIsReplyDefaultH:(BOOL)isDF
{
    ...
    if (self.isReplyDefaultH) {
        ...
        [self.btnReplyMax setTitle:@"收起" forState:(UIControlStateNormal)];
        [self.btnReplyMax setTitle:@"收起" forState:(UIControlStateHighlighted)];
