...
///选中行事件
@property (copy, nonatomic) void(^onRowSelected)(ModelAttentionQuestion *model);

///点击头像
@property (copy ,nonatomic) void(^onImagePhotoClick)(ModelAttentionQuestion *model);

///回答区域点击
@property (copy, nonatomic) void(^onAnswerClick)(ModelAttentionQuestion *model);
