...
///问题选中
@property (copy, nonatomic) void(^onQuestionRowClick)(ModelAttentionQuestion *model);
///头像选中
@property (copy, nonatomic) void(^onPhotoClick)(ModelAttentionQuestion *model);
///答案选中
@property (copy, nonatomic) void(^onAnswerRowClick)(ModelAttentionQuestion *model);
///标签选中
