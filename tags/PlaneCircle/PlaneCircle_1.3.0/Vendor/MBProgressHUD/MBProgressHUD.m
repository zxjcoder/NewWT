...
- (void)setupViews {
    ...
    label.font = [ZFont boldSystemFontOfSize:MBDefaultLabelFontSize];
    label.opaque = NO;
    ...
    detailsLabel.font = [ZFont boldSystemFontOfSize:MBDefaultDetailsLabelFontSize];
    ...
    button.titleLabel.font = [ZFont boldSystemFontOfSize:MBDefaultDetailsLabelFontSize];
...
- (void)setDetailsLabelFont:(ZFont *)detailsLabelFont {
    MBMainThreadAssert();
