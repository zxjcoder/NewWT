...
{
    ZWEAKSELF
    [sns postMyGetQueryQuestionWithUserId:self.modelUB.userId pageNum:self.pageNumAll+1 resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
...
{
    ZWEAKSELF
    [sns postMyGetUpdQuestionWithUserId:self.modelUB.userId pageNum:self.pageNumNew+1 resultBlock:^(NSDictionary *result) {
        GCDMainBlock(^{
