...
-(void)setCellFontSize
{
    ...
    [self.lbTitle setFont:[ZFont boldSystemFontOfSize:kSet_Font_Huge_Size(self.fontSize)]];
...
-(void)setViewContentFrame
{
    ...
    if (self.btnIcon.hidden) {
        ...
        self.cellH = self.btnIcon.y+kSize13;
    } else {
        CGFloat btnH = 25;
        CGFloat btnY = self.lbContent.y+self.lbContent.height+kSize8;
