...
//        [self.tvMain scrollToRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:2] atScrollPosition:(UITableViewScrollPositionNone) animated:NO];
        CGRect newFrame = [self.tvMain rectForHeaderInSection:2];
        [self.tvMain setContentOffset:CGPointMake(0, newFrame.origin.y-self.viewButton.height) animated:NO];
    }
}
///设置热门顶部数量
