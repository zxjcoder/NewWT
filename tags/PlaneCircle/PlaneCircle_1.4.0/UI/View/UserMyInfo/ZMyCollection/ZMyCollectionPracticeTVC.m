...
@interface ZMyCollectionPracticeTVC()//<SWTableViewCellDelegate>
...
-(void)setCellDataWithModel:(ModelCollection *)model
{
    ...
    if (model) {
        ...
        [self.imgLogo setImageURLStr:model.img placeImage:[SkinManager getImageWithName:@"new_image_default"]];
    }
}
-(void)setViewNil
{
