...
- (void)viewDidLoad {
    ...
    if(!_doneButtonImage) {
        ...
        [_doneButton setImage:_doneButtonImage forState:UIControlStateHighlighted];
        [_doneButton setImageEdgeInsets:(UIEdgeInsetsMake(15, 15, 0, 10))];
        [_doneButton setTitleEdgeInsets:(UIEdgeInsetsMake(0, 0, 0, 0))];
        [_doneButton setContentHorizontalAlignment:UIControlContentHorizontalAlignmentLeft];
...
//    CGFloat screenWidth = screenBound.size.width;
    ...
    return CGRectMake(0, 10, 60, 54);//[self.btnBack setFrame:CGRectMake(0, 10, 60, 54)];
}
