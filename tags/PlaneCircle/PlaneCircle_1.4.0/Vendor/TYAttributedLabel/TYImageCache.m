...
- (NSString *) localDirectory
{
    if (_localDirectory == nil) {
        _localDirectory = [AppSetting getAnswerFilePath];
        //[NSString stringWithFormat:@"%@/ImageCache", NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES)[0]];
    }
