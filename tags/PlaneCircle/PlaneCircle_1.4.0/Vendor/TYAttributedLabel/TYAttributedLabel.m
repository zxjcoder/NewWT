...
- (void)setupProperty
{
    ...
    UILongPressGestureRecognizer *longPressGuesture = [[UILongPressGestureRecognizer alloc]initWithTarget:self action:@selector(longPressCopy:)];
    [self addGestureRecognizer:longPressGuesture];
}
...
///长按接收复制
-(void)longPressCopy:(UILongPressGestureRecognizer *)sender
{
    ///长按复制功能
