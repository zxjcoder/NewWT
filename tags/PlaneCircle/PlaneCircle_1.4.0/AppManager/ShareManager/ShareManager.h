...
/// 分享榜单机构 type 1 显示业绩清单; 2 显示律师或会计或券商
#define kShare_RankOrgUrl(ids,type) ([NSString stringWithFormat:@"%@companies/%@?type=%d",kWebServerUrl,ids,type])

/// 分享榜单人员
#define kShare_RankUserUrl(ids) ([NSString stringWithFormat:@"%@staff/%@",kWebServerUrl,ids])
