...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.titleLabel.font = [UIFont boldSystemFontOfSize:kFont_Max_Size];
        ...
        [self.btnBack setFrame:CGRectMake(0, 0, 60, 54)];
        [self.btnBack setImageEdgeInsets:(UIEdgeInsetsMake(30, 10, 0, 10))];
