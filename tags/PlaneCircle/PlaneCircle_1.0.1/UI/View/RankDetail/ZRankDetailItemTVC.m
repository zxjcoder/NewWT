...
-(void)innerInit
{
    ...
    [self.lbSerialNumber setTextColor:BLACKCOLOR2];
    ...
    [self.lbName setTextColor:BLACKCOLOR2];
    ...
    [self.lbCode setTextColor:BLACKCOLOR2];
...
-(void)setViewFrame
{
    ...
    self.cellH = self.lbName.y+self.lbName.height+self.space;
}
