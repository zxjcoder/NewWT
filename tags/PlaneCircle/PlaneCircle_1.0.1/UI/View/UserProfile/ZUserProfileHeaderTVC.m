...
-(void)innerInit
{
    ...
    [self.lbQuestionTitle setText:@"他的问题"];
    [self.lbQuestionTitle setTextColor:DESCCOLOR];
    [self.lbQuestionTitle setTextAlignment:(NSTextAlignmentCenter)];
    [self.lbQuestionTitle setFont:[UIFont systemFontOfSize:kFont_Small_Size]];
    ...
    [self.lbQuestionValue setFont:[UIFont systemFontOfSize:kFont_Default_Size]];
    ...
    [self.lbFansTitle setText:@"他的粉丝"];
    [self.lbFansTitle setTextColor:DESCCOLOR];
    [self.lbFansTitle setTextAlignment:(NSTextAlignmentCenter)];
    [self.lbFansTitle setFont:[UIFont systemFontOfSize:kFont_Small_Size]];
    ...
    [self.lbFansValue setFont:[UIFont systemFontOfSize:kFont_Default_Size]];
    ...
    [self.lbAnswerTitle setText:@"他的回答"];
    [self.lbAnswerTitle setTextColor:DESCCOLOR];
    [self.lbAnswerTitle setTextAlignment:(NSTextAlignmentCenter)];
    [self.lbAnswerTitle setFont:[UIFont systemFontOfSize:kFont_Small_Size]];
    ...
    [self.lbAnswerValue setFont:[UIFont systemFontOfSize:kFont_Default_Size]];
...
-(void)setCellDataWithModel:(ModelUserProfile *)model
{
    ...
    switch (model.sex) {
        ...
        {
            [self.lbAnswerTitle setText:@"她的回答"];
            [self.lbFansTitle setText:@"她的粉丝"];
            [self.lbQuestionTitle setText:@"她的问题"];
            break;
        }
        default:
        {
