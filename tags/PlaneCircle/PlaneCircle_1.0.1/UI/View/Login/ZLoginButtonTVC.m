...
-(void)innerInit
{
    ...
    [self.btnForgotPwd setTitle:@"忘记密码?" forState:(UIControlStateNormal)];
    [self.btnForgotPwd setTitleColor:MAINCOLOR forState:(UIControlStateNormal)];
    [[self.btnForgotPwd titleLabel] setFont:[UIFont boldSystemFontOfSize:kFont_Least_Size]];
    ...
    [[self.btnRegister titleLabel] setFont:[UIFont systemFontOfSize:kFont_Max_Size]];
    ...
    [[self.btnLogin titleLabel] setFont:[UIFont systemFontOfSize:kFont_Max_Size]];
...
-(void)layoutSubviews
{
    ...
    [self.btnForgotPwd setFrame:CGRectMake(self.cellW-spaceX-btnFPW, self.space, btnFPW, 30)];
