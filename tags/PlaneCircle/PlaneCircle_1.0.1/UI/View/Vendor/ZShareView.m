...
{
    self.btnYingXiang = [[ZButton alloc] initWithShareType:(ZShareTypeYingXiang)];
...
-(void)getCancelBtn
{
    ...
    [self.btnCancel setBackgroundColor:TABLEVIEWCELL_LINECOLOR];
    ...
    [[self.btnCancel titleLabel] setFont:[UIFont boldSystemFontOfSize:kFont_Middle_Size]];
...
-(void)setViewFrame
{
    ...
    [self.lbTitle setFrame:CGRectMake(0, 0, self.width, 30)];
    
    CGFloat lineH = 0.8;
    [self.viewLine1 setFrame:CGRectMake(0, self.lbTitle.y+self.lbTitle.height, self.viewContent.width, lineH)];
    ...
    CGFloat cancelH = 35;
    CGFloat contentH = 0;
    CGFloat viewTwoY = btnY+kButtonShareH+space;
    switch (self.showType) {
        case ZShowShareTypeNone:
        {
            [self.viewLine2 setFrame:CGRectMake(0, viewTwoY, self.viewContent.width, lineH)];
            
            CGFloat btnTwoY = self.viewLine2.y+self.viewLine2.height;
            [self.btnCancel setFrame:CGRectMake(0, btnTwoY, self.viewContent.width, cancelH)];
        ...
        case ZShowShareTypeReport:
        {
            ...
            CGFloat btnTwoY = self.viewLine2.y+self.viewLine2.height+space;
            [self.btnReport setBtnPoint:CGPointMake(btnSpace, btnTwoY)];
            
            CGFloat cancelY = btnTwoY+kButtonShareH+space;
            [self.btnCancel setFrame:CGRectMake(0, cancelY, self.viewContent.width, cancelH)];
            contentH = self.btnCancel.y+self.btnCancel.height;
            break;
        }
        case ZShowShareTypeBlacklist:
        ...
        case ZShowShareTypePractice:
        {
            [self.viewLine2 setFrame:CGRectMake(0, viewTwoY, self.viewContent.width, 0)];
