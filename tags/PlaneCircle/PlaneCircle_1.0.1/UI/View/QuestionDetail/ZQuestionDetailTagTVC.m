...
-(void)setViewContent
{
    ...
    for (NSDictionary *dicTopic in self.model.arrTopic) {
        ...
        [btnItem setBackgroundColor:RGBCOLOR(234, 234, 234)];
        [btnItem setViewRound:4 borderWidth:0 borderColor:CLEARCOLOR];
        ...
        [[btnItem titleLabel] setFont:[UIFont systemFontOfSize:kFont_Least_Size]];
        ...
        CGFloat itemW = [[btnItem titleLabel] getLabelWidthWithMinWidth:0]+15;
