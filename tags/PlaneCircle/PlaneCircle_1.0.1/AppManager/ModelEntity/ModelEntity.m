...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self) {
        if ([dic isKindOfClass:[NSDictionary class]]) {
            ...
            self.noticeTitle = [Utils getSNSString:dic[@"title"]];
            self.noticeDesc = [Utils getSNSString:dic[@"desc"]];
            self.noticeTime = [Utils getSNSString:dic[@"time"]];
        }
    }
    return self;
}
...
-(id)initWithDictionary:(NSDictionary*)dic
{
    ...
    if (self) {
        self.openId = [Utils getSNSString:dic[@"openid"]];
        self.nickname = [Utils getSNSString:dic[@"nickname"]];
        self.sex = [Utils getSNSInteger:dic[@"sex"]]==1 ? @"男" : @"女";
...
-(id)initWithCustom:(NSDictionary*)dic
{
    ...
    if (self&&dic) {
        ...
        self.attCount = [Utils getSNSLong:dic[@"count"]];
