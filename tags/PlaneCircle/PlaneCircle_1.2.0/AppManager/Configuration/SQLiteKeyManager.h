...
//是否第一次启动
#define kSQLITE_FRIST_START @"ZSQLITE_FRIST_START"
//上次的意见反馈内容
#define kSQLITE_LAST_FEEDBACK @"kSQLITE_LAST_FEEDBACK"
//意见反馈草稿
#define kSQLITE_LAST_DRAFT @"kSQLITE_LAST_DRAFT"
//修正草稿
#define kSQLITE_LAST_UPDRANK @"kSQLITE_LAST_UPDRANK"
//上次的修正内容
#define kSQLITE_LAST_UPDRANKCONTENT @"kSQLITE_LAST_UPDRANKCONTENT"
//文件大小
...
//上次提示提示修改昵称的时间
#define kSQLITE_LAST_SOWUSERINFOPROMPTTIME @"kSQLITE_LAST_SOWUSERINFOPROMPTTIME"
