...
-(void)sliderValueChanged:(UISlider *)sender
{
    if (sender.value != slidervalue) {
        ...
        [self jumpToPageAtIndex:slidervalue];
    }
}
/// 停止按钮
...
{
    [self.viewNav setFrame:VIEW_NAVV_FRAME];
    ...
    [self.viewTool setFrame:CGRectMake(0, APP_FRAME_HEIGHT-70, APP_FRAME_WIDTH, 70)];
    [self.viewToolBG setFrame:self.viewTool.bounds];
    
    [self.slider setFrame:CGRectMake(0, 5, APP_FRAME_WIDTH, 15)];
