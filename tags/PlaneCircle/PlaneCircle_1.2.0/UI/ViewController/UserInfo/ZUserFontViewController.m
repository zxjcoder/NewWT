...
-(void)innerInit
{
    ...
    [self.lbTitle setText:@"设置字体大小"];
    [self.lbTitle setFont:[UIFont boldSystemFontOfSize:self.fontSize]];
    ...
    [self.lbContent setText:@"请选择下面的字体大小，设置字体大小，设置后，会改变圈子[推荐、动态、最新]、话题详情、问题详情、答案详情、实务文本、我的问题、我的收藏[答案]、我的关注[问题]的字体大小，如果在使用过程中存在问题或意见，可反馈给梧桐Live。"];
    [self.lbContent setFont:[UIFont systemFontOfSize:self.fontSize]];
    ...
    [self.btnMin setTitle:@"小" forState:(UIControlStateNormal)];
    [self.btnMin setTitleColor:BLACKCOLOR1 forState:(UIControlStateNormal)];
    [[self.btnMin titleLabel] setFont:[UIFont boldSystemFontOfSize:kFont_Max_Size]];
    ...
    [self.btnDefault setTitle:@"标准" forState:(UIControlStateNormal)];
    [self.btnDefault setTitleColor:BLACKCOLOR1 forState:(UIControlStateNormal)];
    [[self.btnDefault titleLabel] setFont:[UIFont boldSystemFontOfSize:kFont_Max_Size]];
    ...
    [self.btnMiddle setTitle:@"中等" forState:(UIControlStateNormal)];
    [self.btnMiddle setTitleColor:BLACKCOLOR1 forState:(UIControlStateNormal)];
    [[self.btnMiddle titleLabel] setFont:[UIFont boldSystemFontOfSize:kFont_Max_Size]];
    ...
    [self.btnBig setTitle:@"大" forState:(UIControlStateNormal)];
    [self.btnBig setTitleColor:BLACKCOLOR1 forState:(UIControlStateNormal)];
    [[self.btnBig titleLabel] setFont:[UIFont boldSystemFontOfSize:kFont_Max_Size]];
    ...
    [self.btnLarge setTitle:@"极大" forState:(UIControlStateNormal)];
    [self.btnLarge setTitleColor:BLACKCOLOR1 forState:(UIControlStateNormal)];
    [[self.btnLarge titleLabel] setFont:[UIFont boldSystemFontOfSize:kFont_Max_Size]];
...
-(void)btnRightClick
{
    ...
    [ZProgressHUD showSuccess:@"成功设置字体大小"];
}
