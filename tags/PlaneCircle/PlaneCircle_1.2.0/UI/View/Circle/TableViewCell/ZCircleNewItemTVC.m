...
-(void)setCellFontSize
{
    ...
    [self.lbTitle setFont:[UIFont boldSystemFontOfSize:kSet_Font_Default_Size(self.fontSize)]];
    
    [self.lbNickName setFont:[UIFont systemFontOfSize:kSet_Font_Small_Size(self.fontSize)]];
    [self.lbSign setFont:[UIFont systemFontOfSize:kSet_Font_Minimum_Size(self.fontSize)]];
    
    [self.lbAnswerContent setFont:[UIFont systemFontOfSize:kSet_Font_Small_Size(self.fontSize)]];
    
    [self.lbCount setFont:[UIFont systemFontOfSize:kSet_Font_Minimum_Size(self.fontSize)]];
    [self.lbTime setFont:[UIFont systemFontOfSize:kSet_Font_Minimum_Size(self.fontSize)]];
}
...
-(void)setViewFrame
{
    ...
    CGRect timeImgFrame = CGRectMake(timeX, self.lbTime.y+self.lbTime.height/2-timeS/2+1, timeS, timeS);
