...
-(void)setCellFontSize
{
    ...
    [self.lbNickName setFont:[UIFont systemFontOfSize:kSet_Font_Min_Size(self.fontSize)]];
    [self.lbNickNameDec setFont:[UIFont systemFontOfSize:kSet_Font_Min_Size(self.fontSize)]];
    
    [self.lbTitle setFont:[UIFont boldSystemFontOfSize:kSet_Font_Default_Size(self.fontSize)]];
    [self.lbDesc setFont:[UIFont systemFontOfSize:kSet_Font_Min_Size(self.fontSize)]];
}
