...
#define kZMyAnswerCommentTVCNickNameDesc @"评论了你的答案"
...
-(void)innerInit
{
    ...
    [self.lbNickName setText:kZMyAnswerCommentTVCNickNameDesc];
    [self.lbNickName setTextColor:BLACKCOLOR1];
    [self.lbNickName setFont:[UIFont systemFontOfSize:kFont_Small_Size]];
    ...
    [self.lbContent setFont:[UIFont systemFontOfSize:kFont_Default_Size]];
    ...
    [self.lbComment setFont:[UIFont systemFontOfSize:kFont_Small_Size]];
...
-(void)setCellDataWithModel:(ModelQuestionMyAnswerComment *)model
{
    ...
    if (model) {
        ...
        if (model.nickname.length > 0) {
            [self.lbNickName setText:[NSString stringWithFormat:@"%@%@",model.nickname,kZMyAnswerCommentTVCNickNameDesc]];
            [self.lbNickName setTextColor:RGBCOLOR(251, 107, 33)];
            [self.lbNickName setLabelColorWithRange:NSMakeRange(model.nickname.length, kZMyAnswerCommentTVCNickNameDesc.length) color:BLACKCOLOR1];
        } else {
            [self.lbNickName setText:kZMyAnswerCommentTVCNickNameDesc];
            [self.lbNickName setTextColor:BLACKCOLOR1];
        }
