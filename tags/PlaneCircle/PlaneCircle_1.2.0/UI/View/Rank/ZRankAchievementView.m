...
-(void)innerInit
{
    ...
    [self.lbLawyer setFont:[UIFont systemFontOfSize:kFont_Default_Size]];
    ...
    [self.lbSecurities setFont:[UIFont systemFontOfSize:kFont_Default_Size]];
    ...
    [self.lbAccounting setFont:[UIFont systemFontOfSize:kFont_Default_Size]];
