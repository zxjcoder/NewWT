...
-(void)setCancelButton
{
    ...
    [btnCancel setTitle:kCancel forState:(UIControlStateNormal)];
...
-(void)setRightButtonWithText:(NSString*)text
{
    ...
    if (text.length == 3) {
        [[btnRight titleLabel] setFont:[ZFont boldSystemFontOfSize:kFont_Middle_Size]];
    } else {
        [[btnRight titleLabel] setFont:[ZFont boldSystemFontOfSize:kFont_Default_Size]];
    }
}
