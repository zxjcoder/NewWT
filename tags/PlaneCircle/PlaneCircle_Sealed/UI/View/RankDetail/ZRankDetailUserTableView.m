...
-(void)innerInit
{
    ...
    [self.btnCompany setTitle:kTheListOfALawFirm forState:(UIControlStateNormal)];
    ...
    [self.lbNumber setText:kSerialNumber];
    ...
    [self.lbCode setText:kCompanyCode];
    ...
    [self.lbName setText:kCompanyName];
