...
-(void)innerInit
{
    ...
    [self.lbTitle setText:[NSString stringWithFormat:@"%@:", kPracticalIntroduction]];
    ...
    [self.imgText setTitle:kTextKey forState:(UIControlStateNormal)];
    [self.imgText setTitle:kTextKey forState:(UIControlStateHighlighted)];
