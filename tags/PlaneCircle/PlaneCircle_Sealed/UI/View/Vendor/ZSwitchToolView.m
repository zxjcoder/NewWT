...
//            [self createButtonItem3];
            ...
            [self.btnItem2 setTitle:kAnswer forState:(UIControlStateNormal)];
//            [self.btnItem3 setTitle:kRank forState:(UIControlStateNormal)];
            break;
        }
        ...
        case ZSwitchToolViewItemCircle:
        {
            ...
            switch (sender.tag) {
                case ZCircleToolViewItemHot:
                    //添加统计事件
                    [StatisticsManager event:kEvent_Circle_Recommend category:kCategory_SwitchTool];
                    break;
                case ZCircleToolViewItemTopic:
                    //添加统计事件
                    [StatisticsManager event:kEvent_Circle_Topic category:kCategory_SwitchTool];
                    break;
                case ZCircleToolViewItemNew:
                    //添加统计事件
                    [StatisticsManager event:kEvent_Circle_New category:kCategory_SwitchTool];
                    break;
                case ZCircleToolViewItemDynamic:
                    //添加统计事件
                    [StatisticsManager event:kEvent_Circle_Dynamic category:kCategory_SwitchTool];
                    break;
                default: break;
            }
            break;
