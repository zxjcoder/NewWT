...
-(void)innerInit
{
    ...
    [self.lbTitle setText:kTheListOfALawFirm];
    ...
    [self.lbLawyer setText:kLawFirm];
    ...
    [self.lbSecurities setText:kSecuritiesCompany];
    ...
    [self.lbAccounting setText:kAccountingFirm];
