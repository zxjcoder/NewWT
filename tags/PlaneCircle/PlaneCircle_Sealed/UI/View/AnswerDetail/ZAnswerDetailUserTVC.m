...
-(void)innerInit
{
    ...
    [self.btnAgree setTitle:[NSString stringWithFormat:@"%@0", kAgree] forState:(UIControlStateNormal)];
...
-(void)setButtonText
{
    if (self.modelAB.agree > 999) {
        [self.btnAgree setTitle:[NSString stringWithFormat:@"%@ %d", kAgree, 999] forState:(UIControlStateNormal)];
    } else {
        [self.btnAgree setTitle:[NSString stringWithFormat:@"%@ %ld", kAgree, self.modelAB.agree] forState:(UIControlStateNormal)];
    }
}
