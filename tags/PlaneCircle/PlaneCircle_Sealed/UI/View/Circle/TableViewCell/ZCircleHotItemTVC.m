...
///标题分割线
@property (strong, nonatomic) UIImageView *viewTitleLine;
///回答内容区域
...
//    [self.viewMain addSubview:self.viewTags];
    ...
    self.viewTitleLine = [Utils getLineView];
//    [self.viewTitleLine setBackgroundColor:TABLEVIEWCELL_LINECOLOR];
    ...
    [self.lbNickName setTextColor:SPEAKERCOLOR];
...
{
    return self.lbTitle.frame;
}

///获取回答区域的坐标
-(CGRect)getAnswerFrame
{
    return self.viewContent.frame;
}
